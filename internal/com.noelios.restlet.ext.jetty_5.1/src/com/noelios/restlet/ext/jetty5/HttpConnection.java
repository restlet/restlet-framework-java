...
public class HttpConnection extends org.mortbay.http.HttpConnection
{
    ...
    */
   public HttpConnection(Logger logger, org.mortbay.http.HttpListener listener, InetAddress remoteAddress, InputStream in, OutputStream out, Object connection)
   {
