...
public class BasicAuthenticationSubRouterExample {

    public static class BasicAuthenticationSubRouterApplication extends OpenApiApplication {
        @Override
        public org.restlet.Restlet createInboundRoot() {
            ...
            authenticator.setNext(booksRouter());

            var router = new Router(getContext());
            router.attach("/api", authenticator);
