...
class ReferenceUtilsTestCase {
    ...
    void format_notProxied_returnsPathAndQuery() {
        Request request = new Request(Method.GET, "http://example.com/path?a=b");
    ...
    void format_proxied_returnsFullIdentifier() {
        ...
        assertEquals("http://example.com/path?a=b", result);
    }

    @Test
    void getOriginalRef_withNullHeaders_returnsTargetRef() {
        Reference resourceRef = new Reference("http://example.com/path");
