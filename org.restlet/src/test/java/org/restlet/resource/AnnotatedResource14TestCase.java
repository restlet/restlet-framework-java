 ...
 */
class AnnotatedResource14TestCase extends AbstractAnnotatedResourceWithFinderTestCase {
    ...
    void testQuery(
            final MediaType requestEntityMediaType,
            final MediaType responseMediaTypePreference,
            final String responseEntityAsText)
            throws IOException {
        StringRepresentation requestEntity =
                new StringRepresentation("test", requestEntityMediaType);

        Representation rep =
                responseMediaTypePreference == null
