...
/**
 * Multi-usage parameter. Note that the name and value properties are thread-safe, stored in
 * volatile members.
 *
...
public class Parameter implements Comparable<Parameter>, NamedValue<String> {
     ...
     *
     * @return A series that includes the current parameter as the initial entry.
     */
