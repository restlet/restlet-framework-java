...
public final class CharacterSet extends Metadata {
    ...
    public static final CharacterSet ISO_8859_1 =
            new CharacterSet("ISO-8859-1", "ISO/IEC 8859-1 or Latin 1 character set");
    ...
    public static final CharacterSet ISO_8859_2 =
            new CharacterSet("ISO-8859-2", "ISO/IEC 8859-2 or Latin 2 character set");
    ...
    public static final CharacterSet ISO_8859_3 =
            new CharacterSet("ISO-8859-3", "ISO/IEC 8859-3 or Latin 3 character set");
    ...
    public static final CharacterSet ISO_8859_4 =
            new CharacterSet("ISO-8859-4", "ISO/IEC 8859-4 or Latin 4 character set");
    ...
    public static final CharacterSet ISO_8859_5 =
            new CharacterSet("ISO-8859-5", "ISO/IEC 8859-5 or Cyrillic character set");
    ...
    public static final CharacterSet ISO_8859_6 =
            new CharacterSet("ISO-8859-6", "ISO/IEC 8859-6 or Arabic character set");
    ...
    public static final CharacterSet ISO_8859_7 =
            new CharacterSet("ISO-8859-7", "ISO/IEC 8859-7 or Greek character set");
    ...
    public static final CharacterSet ISO_8859_8 =
            new CharacterSet("ISO-8859-8", "ISO/IEC 8859-8 or Hebrew character set");
    ...
    public static final CharacterSet ISO_8859_9 =
            new CharacterSet("ISO-8859-9", "ISO/IEC 8859-9 or Latin 5 character set");
    ...
    public static final CharacterSet ISO_8859_10 =
            new CharacterSet("ISO-8859-10", "ISO/IEC 8859-10 or Latin 6 character set");
    ...
    public static final CharacterSet MACINTOSH =
            new CharacterSet("macintosh", "Mac OS Roman character set");
    ...
    public static final CharacterSet US_ASCII =
            new CharacterSet("US-ASCII", "US ASCII character set");
    ...
    public static final CharacterSet WINDOWS_1252 =
            new CharacterSet("windows-1252", "Windows 1232 character set");
    ...
    public static final CharacterSet DEFAULT =
            new CharacterSet(java.nio.charset.Charset.defaultCharset());

    /**
     * Handles mapping between Java character set names and IANA preferred name. For example,
     * "MACROMAN" is not an official IANA name and "ISO-8859-6" is preferred over "arabic".
     *
    ...
    /**
     * Returns the character set associated with a name. If an existing constant exists, then it is
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CharacterSet that)) {
            return false;
        }
    ...
    /**
     * Indicates if a given character set is included in the current one. The test is true if both
     * character sets are equal or if the given character set is within the range of the current
     * one. For example, ALL includes all character sets. A null character set is considered as
     * included in the current one.
     *
     * <p>Examples:
     *
     * <ul>
     *   <li>ALL.includes(UTF_16) returns true
     *   <li>UTF_16.includes(ALL) returns false
     * </ul>
     *
