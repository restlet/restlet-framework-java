...
/**
 * Reference to a local resource. It has helper methods for the three following schemes: {@link
 * Protocol#CLAP}, {@link Protocol#FILE}, {@link Protocol#JAR} and {@link Protocol#RIAP}.
 *
 * @author Jerome Louvel
 */
public final class LocalReference extends Reference {
    /**
     * The resources will be resolved from the classloader associated with the local class. This is
     * the same as the {@link #CLAP_CLASS} authority. Examples: clap:///rootPkg/subPkg/myClass.class
    ...
    /**
     * The resources will be resolved from the classloader associated with the local class. This is
     * the default CLAP authority. Examples: clap://class/rootPkg/subPkg/myClass.class or
    ...
    /**
     * The resources will be resolved from the current application's root Restlet. Example
     * riap://application/myPath/myResource
     */
     ...
     * Example riap://component/myAppPath/myResource
     */
    public static final int RIAP_COMPONENT = 5;

    /**
     * The resources will be resolved from the current component's virtual host. Example
     * riap://host/myAppPath/myResource
     */
     ...
     * Constructor.
     *
     * @param hostName The authority (can be a host name or the special "localhost" or an empty
     *     value).
    ...
    /**
     * Localize a path by converting all the separator characters to the system-dependent separator
     * character.
     *
    ...
    /**
     * Normalize a path by converting all the system-dependent separator characters to the standard
     * '/' separator character.
     *
    ...
    /**
     * Gets the local file corresponding to the reference. Only URIs referring to the "localhost" or
     * to an empty authority are supported.
     *
        ...
        if (Protocol.FILE.equals(getSchemeProtocol())) {
            ...
            if ((hostName == null)
                ...
                throw new IllegalArgumentException(
                        "Can't resolve files on remote host machines: " + hostName);
            }
        }
