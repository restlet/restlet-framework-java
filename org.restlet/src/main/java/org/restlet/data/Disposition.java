 ...
 * This is an equivalent of the HTTP "Content-Disposition" header.
 *
 * @see <a href= "http://www.w3.org/Protocols/rfc2616/rfc2616-sec19.html#sec19.5.1"
 *     >Content-Disposition header</a>
 * @see <a href="https://datatracker.ietf.org/doc/html/rfc2183" >The Content-Disposition Header
 *     Field</a>
...
public class Disposition {
    ...
    /**
     * Indicates that the part is intended to be displayed automatically upon display of the full
     * message.
     */
    ...
    public void addDate(String name, Date value) {
        getParameters().add(name, DateUtils.format(value, DateUtils.FORMAT_RFC_822.getFirst()));
    }
    ...
    public void setDate(String name, Date value) {
        getParameters()
                .set(name, DateUtils.format(value, DateUtils.FORMAT_RFC_822.getFirst()), true);
    }
