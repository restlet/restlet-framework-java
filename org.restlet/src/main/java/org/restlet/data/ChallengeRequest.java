...
/**
 * Authentication challenge sent by an origin server to a client. Upon reception of this request,
 * the client should send a new request with the proper {@link ChallengeResponse} set.<br>
 * <br>
...
public final class ChallengeRequest extends ChallengeMessage {
    ...
    /**
     * Returns the available options for quality of protection. The default value is {@link
    ...
    /**
     * Sets the URI references that define the protection domains for the digest authentication.
     * Note that the parameters are copied into a new {@link CopyOnWriteArrayList} instance.
     *
    ...
    /**
     * Sets the available options for quality of protection. The default value is {@link
     * #QUALITY_AUTHENTICATION}.
     *
