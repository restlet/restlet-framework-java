...
/**
 * Particular server behavior that is required by a client. Note that when used with HTTP
 * connectors, this class maps to the "Expect" header.
 *
...
public final class Expectation implements NamedValue<String> {
    ...
    /**
     * Creates a "100-continue" expectation. If a client waits for a 100 (Continue) provisional
     * response before sending the request body, it MUST send this expectation. A client MUST NOT
     * send this expectation if it does not intend to send a request entity.
     *
     * @return A new "100-continue" expectation.
     * @see <a href= "http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.20">HTTP 1.1 -
     *     Expect header</a>
     */
    ...
    public List<Parameter> getParameters() {
        ...
        if (r == null) {
            synchronized (this) {
                r = this.parameters;
                if (r == null) {
                    this.parameters = r = new CopyOnWriteArrayList<>();
                }
            }
        }
        return r;
