...
public final class ServerInfo {
     ...
     * connectors, this property maps to the "Server" header.
     *
     ...
     * Note that when used with HTTP connectors, this property maps to the "Accept-Ranges" header.
     *
     ...
     * this property maps to the "Server" header.
     *
