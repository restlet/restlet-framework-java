...
/**
 * Metadata used to specify the format of representations. The {@link #getName()} method returns a
 * full String representation of the media type including the parameters.
 *
...
public final class MediaType extends Metadata {
    ...
    /**
     * The known media types registered with {@link #register(String, String)}, retrievable using
     * {@link #valueOf(String)}.
     */
    private static final Map<String, MediaType> TYPES = new ConcurrentHashMap<>();

    public static final MediaType ALL = register("*/*", "All media");

    public static final MediaType APPLICATION_ALL =
            register("application/*", "All application documents");

    public static final MediaType APPLICATION_ALL_JSON =
            register("application/*+json", "All application/*+json documents");

    public static final MediaType APPLICATION_ALL_XML =
            register("application/*+xml", "All application/*+xml documents");

    public static final MediaType APPLICATION_ATOM =
            register("application/atom+xml", "Atom document");

    public static final MediaType APPLICATION_ATOMPUB_CATEGORY =
            register("application/atomcat+xml", "Atom category document");

    public static final MediaType APPLICATION_ATOMPUB_SERVICE =
            register("application/atomsvc+xml", "Atom service document");

    public static final MediaType APPLICATION_CAB =
            register("application/vnd.ms-cab-compressed", "Microsoft Cabinet archive");

    public static final MediaType APPLICATION_COMPRESS =
            register("application/x-compress", "Compressed file");

    public static final MediaType APPLICATION_ECORE =
            register("application/x-ecore+xmi+xml", "EMOF ECore metamodel");

    public static final MediaType APPLICATION_EXCEL =
            register("application/vnd.ms-excel", "Microsoft Excel document");

    public static final MediaType APPLICATION_FLASH =
            register("application/x-shockwave-flash", "Shockwave Flash object");

    public static final MediaType APPLICATION_GNU_TAR =
            register("application/x-gtar", "GNU Tar archive");

    public static final MediaType APPLICATION_GNU_ZIP =
            register("application/x-gzip", "GNU Zip archive");

    public static final MediaType APPLICATION_HTTP_COOKIES =
            register("application/x-http-cookies", "HTTP cookies");
    ...
    public static final MediaType APPLICATION_JAVA_ARCHIVE =
            register("application/java-archive", "Java archive");

    public static final MediaType APPLICATION_JAVA_OBJECT =
            register("application/x-java-serialized-object", "Java serialized object");

    public static final MediaType APPLICATION_JAVA_OBJECT_GWT =
            register("text/x-gwt-rpc", "Java serialized object (using GWT-RPC encoder)");

    public static final MediaType APPLICATION_JAVA_OBJECT_XML =
            register("text/x-gwt-rpc+xml", "Java serialized object (using JavaBeans XML encoder)");

    public static final MediaType APPLICATION_JAVASCRIPT =
            register("application/x-javascript", "Javascript document");

    public static final MediaType APPLICATION_JNLP =
            register("application/x-java-jnlp-file", "JNLP");

    public static final MediaType APPLICATION_JSON =
            register("application/json", "JavaScript Object Notation document");

    public static final MediaType APPLICATION_JSON_ACTIVITY =
            register("application/activity+json", "Activity Streams JSON document");

    public static final MediaType APPLICATION_JSON_PATCH =
            register("application/json-patch", "JSON patch document");

    public static final MediaType APPLICATION_JSON_SMILE =
            register("application/x-json-smile", "JavaScript Object Notation smile document");

    public static final MediaType APPLICATION_KML =
            register("application/vnd.google-earth.kml+xml", "Google Earth/Maps KML document");

    public static final MediaType APPLICATION_KMZ =
            register("application/vnd.google-earth.kmz", "Google Earth/Maps KMZ document");
    ...
    public static final MediaType APPLICATION_MAC_BINHEX40 =
            register("application/mac-binhex40", "Mac binhex40");

    public static final MediaType APPLICATION_MATHML =
            register("application/mathml+xml", "MathML XML document");

    public static final MediaType APPLICATION_MSML =
            register("application/msml+xml", "Media Server Markup Language");
    ...
    public static final MediaType APPLICATION_MSOFFICE_ONETOC =
            register("application/onenote", "Microsoft Office OneNote 2007 TOC");

    public static final MediaType APPLICATION_MSOFFICE_ONETOC2 =
            register("application/onenote", "Office OneNote 2007 TOC");
    ...
    public static final MediaType APPLICATION_MSOFFICE_XLAM =
            register("application/vnd.ms-excel.addin.macroEnabled.12", "Office Excel 2007 add-in");
    ...
    public static final MediaType APPLICATION_OCTET_STREAM =
            register("application/octet-stream", "Raw octet stream");

    public static final MediaType APPLICATION_OPENOFFICE_ODB =
            register("application/vnd.oasis.opendocument.database", "OpenDocument Database");

    public static final MediaType APPLICATION_OPENOFFICE_ODC =
            register("application/vnd.oasis.opendocument.chart", "OpenDocument Chart");

    public static final MediaType APPLICATION_OPENOFFICE_ODF =
            register("application/vnd.oasis.opendocument.formula", "OpenDocument Formula");

    public static final MediaType APPLICATION_OPENOFFICE_ODG =
            register("application/vnd.oasis.opendocument.graphics", "OpenDocument Drawing");

    public static final MediaType APPLICATION_OPENOFFICE_ODI =
            register("application/vnd.oasis.opendocument.image", "OpenDocument Image ");
    ...
    public static final MediaType APPLICATION_OPENOFFICE_ODS =
            register("application/vnd.oasis.opendocument.spreadsheet", "OpenDocument Spreadsheet");

    public static final MediaType APPLICATION_OPENOFFICE_ODT =
            register("application/vnd.oasis.opendocument.text ", "OpenDocument Text");
    ...
    public static final MediaType APPLICATION_OPENOFFICE_OTH =
            register("application/vnd.oasis.opendocument.text-web", "HTML Document Template");
    ...
    public static final MediaType APPLICATION_OPENOFFICE_OXT =
            register("application/vnd.openofficeorg.extension", "OpenOffice.org extension");

    public static final MediaType APPLICATION_PDF =
            register("application/pdf", "Adobe PDF document");

    public static final MediaType APPLICATION_POSTSCRIPT =
            register("application/postscript", "Postscript document");

    public static final MediaType APPLICATION_POWERPOINT =
            register("application/vnd.ms-powerpoint", "Microsoft Powerpoint document");

    public static final MediaType APPLICATION_PROJECT =
            register("application/vnd.ms-project", "Microsoft Project document");
    ...
    public static final MediaType APPLICATION_RELAXNG_XML =
            register("application/x-relax-ng+xml", "Relax NG Schema document, XML syntax");

    public static final MediaType APPLICATION_RSS =
            register("application/rss+xml", "Really Simple Syndication document");

    public static final MediaType APPLICATION_RTF =
            register("application/rtf", "Rich Text Format document");

    public static final MediaType APPLICATION_SDP =
            register("application/sdp", "Session Description Protocol");

    public static final MediaType APPLICATION_SPARQL_RESULTS_JSON =
            register("application/sparql-results+json", "SPARQL Query Results JSON document");

    public static final MediaType APPLICATION_SPARQL_RESULTS_XML =
            register("application/sparql-results+xml", "SPARQL Query Results XML document");

    public static final MediaType APPLICATION_SPSS_SAV =
            register("application/x-spss-sav", "SPSS Data");

    public static final MediaType APPLICATION_SPSS_SPS =
            register("application/x-spss-sps", "SPSS Script Syntax");

    public static final MediaType APPLICATION_STATA_STA =
            register("application/x-stata", "Stata data file");

    public static final MediaType APPLICATION_STUFFIT =
            register("application/x-stuffit", "Stuffit archive");
    ...
    public static final MediaType APPLICATION_TROFF_MAN =
            register("application/x-troff-man", "LaTeX");

    public static final MediaType APPLICATION_VOICEXML =
            register("application/voicexml+xml", "VoiceXML");

    public static final MediaType APPLICATION_W3C_SCHEMA =
            register("application/x-xsd+xml", "W3C XML Schema document");

    public static final MediaType APPLICATION_W3C_XSLT =
            register("application/xslt+xml", "W3C XSLT Stylesheet");
    ...
    public static final MediaType APPLICATION_WORD =
            register("application/msword", "Microsoft Word document");

    public static final MediaType APPLICATION_WWW_FORM =
            register("application/x-www-form-urlencoded", "Web form (URL encoded)");
    ...
    public static final MediaType APPLICATION_XQUERY =
            register("application/xquery", "XQuery document");

    public static final MediaType APPLICATION_XUL =
            register("application/vnd.mozilla.xul+xml", "XUL document");

    public static final MediaType APPLICATION_YAML =
            register("application/x-yaml", "YAML document");
    ...
    public static final MediaType MULTIPART_FORM_DATA =
            register("multipart/form-data", "Multipart form data");
    ...
    public static final MediaType TEXT_J2ME_APP_DESCRIPTOR =
            register("text/vnd.sun.j2me.app-descriptor", "J2ME Application Descriptor");

    public static final MediaType TEXT_JAVASCRIPT =
            register("text/javascript", "Javascript document");

    public static final MediaType TEXT_PLAIN = register("text/plain", "Plain text");

    public static final MediaType TEXT_RDF_N3 =
            register("text/n3", "N3 serialized Resource Description Framework document");
    ...
    public static final MediaType TEXT_TSV =
            register("text/tab-separated-values", "Tab-separated Values");

    public static final MediaType TEXT_TURTLE =
            register(
                    "text/turtle", "Plain text serialized Resource Description Framework document");
    ...
    /**
     * Returns the first of the most specific media type of the given array of {@link MediaType}s.
     *
     * <p>Examples:
     *
     * <ul>
     *   <li>"text/plain" is more specific than "text/*" or "image/*"
     *   <li>"text/html" is as specific as "application/pdf" or "image/jpg"
     *   <li>"text/*" is as specific as "application/*" or "image/*"
     *   <li>"*" is the most unspecific MediaType
     * </ul>
     *
    ...
    public static MediaType getMostSpecific(MediaType... mediaTypes)
        ...
        for (int i = 1; i < mediaTypes.length; i++) {
            ...
            if (mediaType == null || "*".equals(mediaType.getMainType())) {
                continue;
            }
        ...
        if (parameters != null && !parameters.isEmpty()) {
            try {
                ...
                Context.getCurrentLogger()
                        .log(Level.INFO, "Unable to parse the media type parameter", e);
            }
        }
    ...
    /**
     * Register a media type as a known type that can later be retrieved using {@link
     * #valueOf(String)}. If the type already exists, the existing type is returned, otherwise a new
     * instance is created.
     *
     * @param name The name.
    ...
    public static synchronized MediaType register(String name, String description) {
        return TYPES.computeIfAbsent(name, n -> new MediaType(n, description));
    }

    /**
     * Returns the media type associated with a name. If an existing constant exists, then it is
    ...
    /**
     * Constructor that clones an original media type by extracting its parent media type then
    ...
    public boolean equals(Object obj, boolean ignoreParameters) {
        ...
        return Objects.equals(getMainType(), that.getMainType())
                && Objects.equals(getSubType(), that.getSubType())
                && (ignoreParameters || getParameters().equals(that.getParameters()));
    }
    ...
    public String getMainType() {
        ...
        return result; // should not be null according to RFC 822
    }

    /**
     * Returns the unmodifiable list of parameters corresponding to subtype modifiers. Creates a new
    ...
    /**
     * {@inheritDoc}<br>
     * In case the media type has parameters, this method returns the concatenation of the main type
     * and the subtype. If the subtype is not equal to "*", it returns the concatenation of the main
     * type and "*". Otherwise, it returns either the {@link #ALL} media type if it is already the
     * {@link #ALL} media type, or null.
     */
    @Override
    ...
    /**
     * Indicates if a given media type is included in the current one @see {@link
     * #includes(Metadata, boolean)}. It ignores the parameters.
     *
    ...
    /**
     * Indicates if a given media type is included in the current one @see {@link
     * #includes(Metadata, boolean)}. The test is true if both types are equal or if the given media
     * type is within the range of the current one. For example, ALL includes all media types.
     * Parameters are ignored for this comparison. A null media type is considered as included into
    ...
    public boolean includes(Metadata included, boolean ignoreParameters) {
        if (equals(ALL) || equals(included)) {
            return true;
        }
        if (!(included instanceof final MediaType includedMediaType)) {
            return false;
        }

        boolean result = false;

        final String mainType = getMainType();
        if (mainType == null) { // Should not happen
            return false;
        }
        if (!mainType.equals(includedMediaType.getMainType())) {
            return false;
        }
        final String subType = getSubType();
        final String subTypeIncluded = includedMediaType.getSubType();
        if (subType == null || subTypeIncluded == null) { // Should not happen
            return false;
        }

        if (subType.equals(subTypeIncluded)) {
            result = ignoreParameters || parametersAreEqual(includedMediaType);
        } else if (subType.equals("*")) {
            result = true;
        } else if (subType.startsWith("*+") && subTypeIncluded.endsWith(subType.substring(2))) {
            result = true;
        }
    ...
    private boolean parametersAreEqual(final MediaType includedMediaType) {
        boolean result = true;
        // Check parameters:
    ...
    /**
     * Checks if the current media type is concrete. A media type is concrete if neither the main
     * type nor the subtype are equal to "*".
     *
