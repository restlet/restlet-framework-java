...
public class Form extends Series<Parameter> {
     ...
     *
     * @param queryString The Web form parameters as a string.
     * @param decode Indicates if the names and values should be automatically decoded.
     */
    ...
    /**
     * Formats the form as a matrix path string. Uses UTF-8 as the character set for encoding
     * non-ASCII characters.
     *
     * @return The form as a matrix string.
     * @see <a href="http://www.w3.org/DesignIssues/MatrixURIs.html">Matrix URIs by Tim
     *     Berners-Lee</a>
     */
    ...
    /**
     * Formats the form as a query string. Uses UTF-8 as the character set for encoding non-ASCII
     * characters.
     *
    ...
    /**
     * Returns the form as a Web representation (MediaType.APPLICATION_WWW_FORM). Uses UTF-8 as the
     * character set for encoding non-ASCII characters.
     *
    ...
    public Representation getWebRepresentation(CharacterSet characterSet) {
        return new StringRepresentation(
                getQueryString(characterSet), MediaType.APPLICATION_WWW_FORM, null, characterSet);
    }
}
