...
public final class Encoding extends Metadata {
    ...
    public static final Encoding FREEMARKER =
            new Encoding("freemarker", "FreeMarker templated representation");
    ...
    public static final Encoding VELOCITY =
            new Encoding("velocity", "Velocity templated representation");

    /** The Info-Zip encoding. */
    public static final Encoding ZIP = new Encoding("zip", "Zip compression");

    /**
     * Returns the encoding associated with a name. If an existing constant exists, then it is
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof Encoding that)) {
            return false;
        }
    ...
    /**
     * Indicates if a given encoding is included in the current one. The test is true if both
     * encodings are equal or if the given encoding is within the range of the current one. For
     * example, ALL includes all encodings. A null encoding is considered as included in the current
     * one.
     *
     * <p>Examples:
     *
     * <ul>
     *   <li>ALL.includes(COMPRESS) returns true
     *   <li>COMPRESS.includes(ALL) returns false
     * </ul>
     *
