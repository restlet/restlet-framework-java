...
/**
 * Directive for caching mechanisms along the call chain. This overrides the default behavior of
 * those caches and proxies.<br>
 * <br>
...
public final class CacheDirective implements NamedValue<String> {
    ...
    /**
     * Creates a "max-age" directive. Indicates that the client is willing to accept a response
     * whose age is not greater than the specified time in seconds. Unless the "max-stale" directive
     * is also included, the client is not willing to accept a stale response.<br>
     * <br>
     ...
     *     Modifications of the Basic Expiration Mechanism</a>
     * @see <a href= "http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.4">HTTP 1.1 -
     *     Cache Revalidation and Reload Controls</a>
     */
    ...
    /**
     * Creates a "max-stale" directive. Indicates that the client is willing to accept a response
     * that has exceeded its expiration time by any amount of time.<br>
     * <br>
    ...
    /**
     * Creates a "max-stale" directive. Indicates that the client is willing to accept a response
     * that has exceeded its expiration time by a given amount of time.<br>
     * <br>
     * Note that this directive can be used on requests only.
     *
    ...
    public static CacheDirective maxStale(int maxStale) {
        return new CacheDirective(
                HeaderConstants.CACHE_MAX_STALE, Integer.toString(maxStale), true);
    }

    /**
     * Creates a "min-fresh" directive. Indicates that the client is willing to accept a response
    ...
    public static CacheDirective minFresh(int minFresh) {
        return new CacheDirective(
                HeaderConstants.CACHE_MIN_FRESH, Integer.toString(minFresh), true);
    }

    /**
     * Creates a "must-revalidate" directive. Indicates that the origin server requires revalidation
     * of a cache entry on any later use.<br>
     * <br>
    ...
    /**
     * Creates a "no-cache" directive. Indicates that a cache must not use the response to satisfy
     * later requests without successful revalidation with the origin server.<br>
     * <br>
     * Note that this directive can be used on requests or responses.
     *
     ...
     * Note that this directive can be used on requests or responses.
     *
     * @param fieldNames Field names, typically an HTTP header name, that must not be sent by
     *     caches.
     * @return A new "no-cache" directive.
     * @see <a href= "http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.1">HTTP 1.1 -
     *     What is Cacheable</a>
     ...
     * Note that this directive can be used on requests or responses.
     *
     * @param fieldName A field name, typically an HTTP header name, that must not be sent by
     *     caches.
     * @return A new "no-cache" directive.
     * @see <a href= "http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.1">HTTP 1.1 -
     *     What is Cacheable</a>
    ...
    /**
     * Creates a "no-store" directive. Indicates that a cache must not release or retain any
     * information about the call. This applies to both private and shared caches.<br>
     * <br>
     * Note that this directive can be used on requests or responses.
     *
     * @return A new "no-store" directive.
     * @see <a href= "http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.2">HTTP 1.1 -
     *     What May be Stored by Caches</a>
     */
    ...
    /**
     * Creates an "onlyIfCached" directive. Indicates that only cached responses should be returned
     * to the client.<br>
     * <br>
     * Note that this directive can be used on requests only.
     *
    ...
    /**
     * Creates a "private" directive. Indicates that all or part of the response message is intended
     * for a single user and must not be cached by a shared cache.<br>
     * <br>
     * Note that this directive can be used on responses only.
     *
     ...
     * Note that this directive can be used on responses only.
     *
     * @param fieldNames Field names, typically an HTTP header name, that must be private.
     * @return A new "private" directive.
     * @see <a href= "http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.1">HTTP 1.1 -
     *     What is Cacheable</a>
     */
     ...
     * Note that this directive can be used on responses only.
     *
     * @param fieldName A field name, typically an HTTP header name, that is private.
     * @return A new "private" directive.
     * @see <a href= "http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.1">HTTP 1.1 -
     *     What is Cacheable</a>
     */
    ...
    /**
     * Creates a "proxy-revalidate" directive. Indicates that the origin server requires
     * revalidation of a cache entry on any later use, except that it does not apply to non-shared
     * user agent caches<br>
     * <br>
     * Note that this directive can be used on responses only.
     *
    ...
    /**
     * Creates a "public" directive. Indicates that any cache may cache the response, even if it
     * would normally be non-cacheable or cacheable only within a non-shared cache.<br>
     * <br>
     * Note that this directive can be used on responses only.
     *
    ...
    /**
     * Creates an "s-maxage" directive. Indicates that the client is willing to accept a response
     * from a shared cache (but not a private cache) whose age is not greater than the specified
     * time in seconds.<br>
     * <br>
     * Note that this directive can be used on responses only.
     *
    ...
    public static CacheDirective sharedMaxAge(int sharedMaxAge) {
        return new CacheDirective(
                HeaderConstants.CACHE_SHARED_MAX_AGE, Integer.toString(sharedMaxAge), true);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CacheDirective that)) {
            return false;
        }
