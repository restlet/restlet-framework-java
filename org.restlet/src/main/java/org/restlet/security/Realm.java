...
public abstract class Realm {
    ...
    /**
     * The verifier that can check the validity of the user credentials associated with a request.
     */
     ...
     * Constructor.
     *
     * @param verifier The verifier that can check the validity of the credentials associated with a
     *     request.
     * @param enroler The enroler that can add the user roles based on user principals.
     */
    protected Realm(Verifier verifier, Enroler enroler) {
        this.enroler = enroler;
        this.verifier = verifier;
        this.parameters =
                new Series<Parameter>(Parameter.class, new CopyOnWriteArrayList<Parameter>());
        this.started = false;
    }
     ...
     * value and is typically used for configuration purposes, like Java properties. Note that
    ...
    /**
     * Sets a verifier that can check the validity of the credentials associated with a request.
     *
