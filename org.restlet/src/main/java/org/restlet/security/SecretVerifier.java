...
/**
 * Verifier of identifier/secret couples. By default, it extracts the identifier and the secret from
 * the {@link ChallengeResponse}. If the verification is successful, it automatically adds a new
 * {@link User} for the given identifier.
 *
...
public abstract class SecretVerifier implements Verifier {
     ...
     * compares the inputSecret of the request's authentication response with the one obtain by the
     * {@link ChallengeResponse#getSecret()} method and sets the {@link org.restlet.security.User}
     * instance of the request's {@link ClientInfo} if successful.
     *
     * @param request The request to inspect.
     * @param response The response to inspect.
    ...
    /**
     * Verifies that the identifier/secret couple is valid. It throws an IllegalArgumentException in
     * case the identifier is either null or does not identify a user.
     *
