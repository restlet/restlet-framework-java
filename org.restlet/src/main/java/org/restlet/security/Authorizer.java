...
/**
 * Filter authorizing inbound request. It can be attached to protect a set of downstream {@link
 * Restlet} and {@link ServerResource} objects.
 *
...
public abstract class Authorizer extends Filter {
    ...
    /**
     * Authorizer returning true for all authenticated requests. For unauthenticated requests, it
     * sets the response's status to {@link Status#CLIENT_ERROR_UNAUTHORIZED} instead of the default
     ...
     */
    protected Authorizer(String identifier) {
    ...
    /**
     * Invoked upon successful authorization. Returns {@link Filter#CONTINUE} by default.
     *
     * @param request The request sent.
     * @param response The response to modify.
    ...
    /**
     * Invoked upon failed authorization. Sets the status to {@link Status#CLIENT_ERROR_FORBIDDEN}
     * and returns {@link Filter#STOP} by default.
     *
     * @param request The request sent.
     * @param response The response to modify.
     * @return The filter continuation code.
