...
public class Group {
    ...
    /**
     * Indicates if the roles of the parent group should be inherited. Those roles indirectly cover
     * the granted or denied permissions.
     */
     ...
     * @param name The display name.
     * @param description The description.
     * @param inheritingRoles Indicates if the roles of the parent group should be inherited.
     */
    ...
    /**
     * Sets the modifiable list of member groups. This method clears the current list and adds all
    ...
    /**
     * Sets the modifiable list of member user references. This method clears the current list and
