...
/**
 * Verifier that stores its local secrets in a map indexed by the identifier. Note that this
 * verifier isn't very secure by itself.
 *
...
public class MapVerifier extends LocalVerifier {
    ...
    /**
     * Sets the modifiable map of local secrets. This method clears the current map and puts all
