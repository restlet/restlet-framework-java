...
/**
 * Verifier that can locally retrieve the secrets. This verifier assumes that the secret associated
 * to an identifier can be retrieved, which isn't always possible or even desirable.
 *
