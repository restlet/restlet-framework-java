...
/**
 * Connector acting as a generic server. It internally uses one of the available connector helpers
 * registered with the Restlet engine.<br>
 * <br>
 ...
 * state in member variables.<br>
 * <br>
 * For advanced cases, it is possible to obtain the wrapped {@link RestletHelper} instance that is
 * used by this client to handle the calls via the "org.restlet.engine.helper" attribute stored in
...
public class Server extends Connector {
     ...
     *     You can also use a domain name as an alias for the IP address to listen to.
     * @param port The listening port.
     * @param next The next Restlet.
     */
    public Server(
            Context context, List<Protocol> protocols, String address, int port, Restlet next) {
     ...
     *
     * @param protocol The connector protocol.
     * @param address The listening IP address (useful if multiple IP addresses available). You can
     *     also use a domain name as an alias for the IP address to listen to.
     */
    ...
    /**
     * Returns the actual server port after it has started. If an ephemeral port is used it will be
     * returned, otherwise the fixed port will be provided.
     *
    ...
    /**
     * Returns the actual ephemeral port used when the listening port is set to '0'. The default
     * value is '-1' if no ephemeral port is known. See InetSocketAddress#InetSocketAddress(int) and
     * ServerSocket#getLocalPort() methods for details.
     *
    ...
    /**
     * Indicates if the next Restlet is set.
     *
    ...
    /**
     * Sets the next Restlet as a Finder for a given resource class. When the call is delegated to
     * the Finder instance, a new instance of the resource class will be created and will actually
     * handle the request.
     *
    ...
    /**
     * Sets the listening port if specified. Note that '0' means that the system will pick up an
     * ephemeral port at the binding time. This ephemeral can be retrieved once the server is
     * started using the {@link #getEphemeralPort()} method.
     *
