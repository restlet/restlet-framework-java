...
/**
 * Restlet enabling communication between Components. "A connector is an abstract mechanism that
 * mediates communication, coordination, or cooperation among components. Connectors enable
 * communication between components by transferring data elements from one interface to another
 ...
 * connectors present an abstract interface for component communication, enhancing simplicity by
 * providing a clean separation of concerns and hiding the underlying implementation of resources
 * and communication mechanisms" Roy T. Fielding<br>
 * <br>
 ...
 *
 * @see <a href= "http://roy.gbiv.com/pubs/dissertation/software_arch.htm#sec_1_2_2">Source
 *     dissertation</a>
 * @see <a href= "http://roy.gbiv.com/pubs/dissertation/rest_arch_style.htm#sec_5_2_2">Source
 *     dissertation</a>
...
public abstract class Connector extends Restlet {
     ...
     */
    protected Connector(Context context, List<Protocol> protocols) {
        super(context);
    ...
    /**
     * Sets the list of protocols simultaneously supported. This method clears the current list and
