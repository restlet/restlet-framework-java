...
public class Response extends Message {
     ...
     *
     * <p>Warning: this method should only be used under duress. You should by default prefer
     * obtaining the current context using methods such as {@link
     * org.restlet.resource.Resource#getResponse()}.
     *
     * <p>This variable is stored internally as a thread local variable and updated each time a call
     * is handled by a Restlet via the {@link Restlet#handle(org.restlet.Request,
     * org.restlet.Response)} method.
     *
    ...
    /**
     * When used as part of a response to a preflight CORS request, this indicates whether the
     * actual request can be made using credentials.
     */
    private volatile Boolean accessControlAllowCredentials;

    /**
     * When used as part of a response to a preflight CORS request, this lists the headers allowed
     * by the actual request on the current resource.
     */
    private volatile Set<String> accessControlAllowHeaders;

    /**
     * When used as part of a response to a preflight CORS request, this lists the methods allowed
     * by the actual request on the current resource.
     */
    private volatile Set<Method> accessControlAllowMethods;

    /**
     * When used in the context of CORS support, it specifies the URI an origin server allows for
     * the requested resource. Use "*" as a wildcard character.
     */
     ...
     * request can be cached in a preflight result cache.
     */
    ...
    /**
     * The authentication information sent by an origin server to a client in the case of a
    ...
    /**
     * Asks the server connector to immediately commit the given response, making it ready to be
     * sent back to the client. Note that all server connectors don't necessarily support this
     * feature.<br>
     * <br>
     * When the response is in autoCommit mode (see related property), then calling this method
     * isn't necessary. Also, be aware that committing the response doesn't necessarily mean that it
     * will immediately be written on the network as some buffering can occur. If you want to ensure
     * that response buffers are flushed.<br>
     * <br>
     * Note that this calls back {@link Request#commit(Response)} on the parent request which holds
     * the link with the underlying network connection.
     */
    public void commit() {
    ...
    /**
     * Asks the server connector to immediately flush the network buffers. Note that this calls back
     * {@link Request#flushBuffers()} on the parent request which holds the link with the underlying
     * network connection.
     *
     * @throws IOException
     */
    ...
    /**
     * When used as part of a response to a preflight CORS request, this indicates whether the
     * actual request can be made using credentials.<br>
     ...
     *
     * @return The set of headers allowed by the actual request on the current resource.
     */
    public Set<String> getAccessControlAllowHeaders() {
        ...
        if (a == null) {
            synchronized (this) {
                ...
                if (a == null) {
                    this.accessControlAllowHeaders = a = new CopyOnWriteArraySet<>();
                }
            }
        }
        return a;
    ...
    /**
     * Returns the modifiable set of methods allowed by the actual request on the current resource
     * when used as part of a response to a preflight CORS request<br>
     * Note that when used with HTTP connectors, this property maps to the
     * "Access-Control-Allow-Methods" header.
     *
     * @return The set of methods allowed by the actual request on the current resource.
     */
    ...
    /**
     * When used in the context of CORS support, it returns the URI an origin server allows for the
     * requested resource. Use "*" as a wildcard character.<br>
     * Note that when used with HTTP connectors, this property maps to the
     ...
     *
     * @return The set of headers an origin server allows for the requested resource.
     */
    ...
    /**
     * Indicates how long the results of a preflight CORS request can be cached in a preflight
     * result cache.<br>
     * In case of a negative value, the results of a preflight request are not meant to be cached.
     * <br>
     * Note that when used with HTTP connectors, this property maps to the "Access-Control-Max-Age"
     * header.
     *
     * @return Indicates how long the results of a preflight request can be cached in a preflight
     *     result cache.
     */
    ...
    /**
     * Returns the estimated amount of time since a response was generated or revalidated by the
     * origin server. Origin servers should leave the 0 default value. Only caches are expected to
    ...
    /**
     * Returns the modifiable set of methods allowed on the requested resource. This property only
     * has to be updated when a status CLIENT_ERROR_METHOD_NOT_ALLOWED is set. Creates a new
    ...
    /**
     * Returns information sent by an origin server related to a successful authentication attempt.
     * If none is available, null is returned.<br>
     * <br>
     * Note that when used with HTTP connectors, this property maps to the "Authentication-Info"
     * header.
     *
    ...
    /**
     * Returns the list of authentication requests sent by an origin server to a client. If none is
     * available, an empty list is returned.<br>
     * <br>
     * Note that when used with HTTP connectors, this property maps to the "WWW-Authenticate"
     * header.
     *
    ...
    /**
     * Returns the modifiable series of cookie settings provided by the server. Creates a new
     * instance if no one has been set.<br>
     * <br>
     * Note that when used with HTTP connectors, this property maps to the "Set-Cookie" and
     * "Set-Cookie2" headers.
     *
    ...
    public Series<CookieSetting> getCookieSettings() {
        ...
        if (c == null) {
            synchronized (this) {
                ...
                if (c == null) {
                    this.cookieSettings = c = new Series<>(CookieSetting.class);
                }
            }
        }
        return c;
    ...
    /**
     * Returns the modifiable set of selecting dimensions on which the response entity may vary. If
     * some server-side content negotiation is done, this set should be properly updated, other it
     * can be left empty. Creates a new instance if no one has been set.<br>
     * <br>
    ...
    /**
     * Returns the location reference. This is the reference that the client should follow for
     * redirections or resource creations.<br>
     * <br>
     ...
     * available, an empty list is returned.<br>
     * <br>
     * Note that when used with HTTP connectors, this property maps to the "Proxy-Authenticate"
     * header.
     *
     * @return The list of authentication requests.
     */
    ...
    /**
     * Indicates how long the service is expected to be unavailable to the requesting client. The
     ...
     * server-side, setting this property to 'false' let you ask to the server connector to wait
    ...
    /**
     * Indicates if the response is final or provisional. It relies on the {@link
     * Status#isInformational()} method.
     *
    ...
    /**
     * Indicates if the response is provisional or final. It relies on the {@link
     * Status#isInformational()} method.
     *
    ...
    /**
     * When used as part of a response to a preflight CORS request, indicates whether or not the
     * actual request can be made using credentials. <br>
     * Note that when used with HTTP connectors, this property maps to the
     * "Access-Control-Allow-Credentials" header.
     *
     * @param accessControlAllowCredentials True if the requested resource allows credential.
     */
    ...
    /**
     * When used as part of a response to a preflight CORS request, indicates how long (in seconds)
     * the results of a preflight request can be cached in a preflight result cache.<br>
     * Note that when used with HTTP connectors, this property maps to the "Access-Control-Max-Age"
     * header.<br>
     * In case of negative value, the header is not set.
     *
     * @param accessControlMaxAge How long the results of a preflight request can be cached in a
    ...
    /**
     * Sets the set of headers allowed by the actual request on the current resource when used as
     * part of a response to a preflight CORS request.<br>
     * Note that when used with HTTP connectors, this property maps to the
     * "Access-Control-Allow-Headers" header.
     *
     * @param accessControlAllowHeaders The set of headers allowed by the actual request on the
     *     current resource.
     */
    ...
    /**
     * Sets the set of methods allowed by the actual request on the current resource when used as
     * part of a response to a preflight CORS request.<br>
     * Note that when used with HTTP connectors, this property maps to the
     * "Access-Control-Allow-Methods" header.
     *
     * @param accessControlAllowMethods The set of methods allowed by the actual request on the
     *     current resource.
     */
    ...
    /**
     * When used in the context of CORS support, it sets the URI an origin server allows for the
     * requested resource. Use "*" as a wildcard character.<br>
     * Note that when used with HTTP connectors, this property maps to the
     * "Access-Control-Allow-Origin" header.
     *
    ...
    /**
     * Sets the list of headers an origin server allows for the requested resource.<br>
     * Note that when used with HTTP connectors, this property maps to the
     * "Access-Control-Expose-Headers" header.
     *
     * @param accessControlExposeHeaders The set of headers an origin server allows for the
     *     requested resource.
     */
    ...
    /**
     * Sets the estimated amount of time since a response was generated or revalidated by the origin
     * server. Origin servers should leave the 0 default value. Only caches are expected to set this
     * property.<br>
     * <br>
     * Note that when used with HTTP connectors, this property maps to the "Age" header.
     *
     ...
     * thread-safe (use {@link CopyOnWriteArraySet} for example.<br>
     * <br>
     * Note that when used with HTTP connectors, this property maps to the "Allow" header.
     *
    ...
    /**
     * Sets the authentication information sent by an origin server to a client after a successful
    ...
    /**
     * Sets the list of authentication requests sent by an origin server to a client. Note that when
     * used with HTTP connectors, this property maps to the "WWW-Authenticate" header. This method
     * clears the current list and adds all entries in the parameter list.
     *
     * @param challengeRequests A list of authentication requests sent by an origin server to a
     *     client.
     */
    ...
    /**
     * Sets the modifiable series of cookie settings provided by the server. Note that when used
     * with HTTP connectors, this property maps to the "Set-Cookie" and "Set-Cookie2" headers. This
     * method clears the current series and adds all entries in the parameter series.
     *
    ...
    /**
     * Sets the set of dimensions on which the response entity may vary. Note that when used with
     * HTTP connectors, this property maps to the "Vary" header. This method clears the current set
     * and adds all entries in the parameter set.
     *
    ...
    /**
     * Sets the reference that the client should follow for redirections or resource creations. Note
     * that when used with HTTP connectors, this property maps to the "Location" header.
     *
    ...
    /**
     * Sets the modifiable list of authentication requests sent by a proxy to a client. The list
     * instance set must be thread-safe (use {@link CopyOnWriteArrayList} for example. Note that
     * when used with HTTP connectors, this property maps to the "Proxy-Authenticate" header. This
