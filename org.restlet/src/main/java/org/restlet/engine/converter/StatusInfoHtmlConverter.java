...
public class StatusInfoHtmlConverter extends ConverterHelper {
    ...
    private static final VariantInfo VARIANT_APPLICATION_XHTML =
            new VariantInfo(MediaType.APPLICATION_XHTML);
    ...
    /**
     * Returns the status information to display in the default representation. By default, it
    ...
    protected String getStatusLabel(StatusInfo status) {
        return (status.getReasonPhrase() != null)
     ...
     * To customize the default representation, this method can be overridden.
     *
     * @param status The status info to represent.
