...
public class JettyClientCall extends ClientCall {
     ...
     */
    public JettyClientCall(HttpClientHelper helper, final String method, final String requestUri) {
    ...
    public InputStream getResponseEntityStream(long size) {
        final InputStreamResponseListener isrl = getInputStreamResponseListener();
        return isrl == null ? null : isrl.getInputStream();
    }
     ...
     *
     * <p>As a jetty client decodes the input stream on the fly, we have to clear the {@link
     * org.restlet.representation.Representation#getEncodings()} to avoid decoding the input stream
     * another time.
     *
    ...
    public Status sendRequest(org.restlet.Request request) {
        ...
        try {
            ...
            this.response =
                    this.inputStreamResponseListener.get(
            ...
            this.clientHelper
                    .getLogger()
                    .log(Level.WARNING, "An error occurred while reading the request entity.", e);
            ...
            this.clientHelper
                    .getLogger()
                    .log(Level.WARNING, "The HTTP request thread was interrupted.", e);
            result = new Status(Status.CONNECTOR_ERROR_COMMUNICATION, e);
            ...
            this.clientHelper
                    .getLogger()
                    .log(Level.WARNING, "An error occurred while processing the HTTP request.", e);
            result = new Status(Status.CONNECTOR_ERROR_COMMUNICATION, e);
    ...
    public void sendRequest(
            org.restlet.Request request, org.restlet.Response response, Uniform callback) {
        sendRequest(request);
