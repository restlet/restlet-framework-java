...
public abstract class HeaderWriter<V> extends StringWriter {
    ...
    /**
     * Appends a string as an HTTP comment, surrounded by parenthesis and with quoted pairs if
     * needed.
     *
    ...
    /**
     * Formats and appends a parameter as an extension. If the value is not a token, then it is
     * quoted.
     *
    ...
    /**
     * Formats and appends a source string as a URI encoded string.
     *
    ...
    /**
     * Indicates if the value can be written to the header. Useful to prevent the writing of {@link
