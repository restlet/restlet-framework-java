...
public class ChallengeWriter extends HeaderWriter<ChallengeRequest> {
    ...
    /**
     * Appends a new challenge parameter, prefixed with a comma. The value is separated from the
     * name by a '=' character.
     *
    ...
    /**
     * Appends a new parameter, prefixed with a comma. The value is separated from the name by a '='
     * character.
     *
     * @param name The parameter name.
    ...
    /**
     * Appends a new parameter, prefixed with a comma. The value is quoted and separated from the
     * name by a '=' character.
     *
     * @param name The parameter name.
