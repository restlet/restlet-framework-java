...
public class WriterOutputStream extends OutputStream {
     ...
     * @param characterSet The character set. Use {@link CharacterSet#ISO_8859_1} by default if a
     *     null value is given.
     */
    public WriterOutputStream(Writer writer, CharacterSet characterSet) {
        this.writer = writer;
        this.charSet =
                (characterSet == null) ? StandardCharsets.ISO_8859_1 : characterSet.toCharset();
    }
