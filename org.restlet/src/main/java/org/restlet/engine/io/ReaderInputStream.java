...
/**
 * Input stream based on a reader. The implementation relies on the NIO {@link CharsetEncoder}
 * class.
 *
...
public class ReaderInputStream extends InputStream {
    ...
    /**
     * Constructor. Uses the {@link CharacterSet#ISO_8859_1} character set by default.
     *
    ...
    public ReaderInputStream(Reader reader, CharacterSet characterSet) {
        ...
        this.charsetEncoder =
                (characterSet == null)
                        ? CharacterSet.ISO_8859_1.toCharset().newEncoder()
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        ...
        while (iterate) {
            ...
            // Copies as many bytes as possible in the target array
            ...
            iterate =
                    (len > 0)
                            && (!this.endReached
                                    || this.byteBuffer.hasRemaining()
                                    || this.charBuffer.hasRemaining());
        }
