...
/**
 * Chain helper serving as a base class for Application and Component helpers.
 *
...
public abstract class CompositeHelper<T extends Restlet> extends RestletHelper<T> {
     ...
     */
    protected CompositeHelper(T helped) {
        super(helped);
        ...
        if (getFirstInboundFilter() != null) {
            ...
            if (next != null) {
                ...
                getHelped()
                        ...
                        .log(
                                Level.SEVERE,
                                "The {0} class has no Restlet defined to process calls. Maybe it wasn''t properly started.",
