...
public class DefaultSslContext extends SSLContext {
    ...
    /**
     * Creates a SSL context SPI capable or setting additional properties on the created SSL engines
    ...
    public DefaultSslContext(DefaultSslContextFactory contextFactory, SSLContext wrappedContext) {
        super(
                createContextSpi(contextFactory, wrappedContext),
                wrappedContext.getProvider(),
