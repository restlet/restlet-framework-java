...
/**
 * Default SSL context SPI capable or setting additional properties on the created SSL engines and
 * socket factories.
 *
...
public class WrapperSslContextSpi extends SSLContextSpi {
    ...
    protected SSLServerSocketFactory engineGetServerSocketFactory() {
        return new WrapperSslServerSocketFactory(
                getContextFactory(), getWrappedContext().getServerSocketFactory());
    }

    @Override
    protected SSLSocketFactory engineGetSocketFactory() {
        return new WrapperSslSocketFactory(
                getContextFactory(), getWrappedContext().getSocketFactory());
    }
