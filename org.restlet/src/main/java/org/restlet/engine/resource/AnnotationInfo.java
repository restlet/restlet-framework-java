...
public abstract class AnnotationInfo {
    ...
    protected static Class<?> getJavaActualType(Class<?> currentClass, String genericTypeName) {
        ...
        if (result == null) {
            // Lookup at the implemented interfaces
    ...
    protected static Class<?> getJavaActualType(Type currentType, String genericTypeName) {
        ...
        if (currentType != null) {
            ...
            } else if (currentType instanceof final ParameterizedType parameterizedType) {
    ...
    protected static Class<?> getTypeClass(Type type) {
        ...
        if (type instanceof Class<?>) {
            ...
            result = getTypeClass(parameterizedType.getRawType());
     ...
     * @param annotationValue The annotation value.
     */
    protected AnnotationInfo(Class<?> javaClass, String annotationValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof final AnnotationInfo that)) {
            return false;
        }
        ...
        try {
            ...
            Context.getCurrentLogger()
                    .log(
                            Level.WARNING,
                            exception,
                            () -> "Cannot get actual type of generic type: " + genericType);
        }
    ...
    public String toString() {
        return "AnnotationInfo [javaMethod: "
                + javaMethod
                + ", javaClass: "
                + javaClass
                + ", value: "
