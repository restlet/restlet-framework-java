...
public class EncodeRepresentation extends WrapperRepresentation {
    ...
    /**
     * Returns the available size in bytes of the encoded representation if known, UNKNOWN_SIZE (-1)
     * otherwise.
     *
    ...
    /**
     * Returns the size in bytes of the encoded representation if known, UNKNOWN_SIZE (-1)
     * otherwise.
     *
