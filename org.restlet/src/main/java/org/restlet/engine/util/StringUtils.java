...
public class StringUtils {
     ...
     *
     * @param name Character reference.
     * @param numericValue Numeric character reference.
     * @author Thierry Boileau
     */
    private record CharacterEntity(Integer numericValue, String name) {}

    /**
     * Stores a list of entities and is able to return one given its numeric value or name.
     *
     * @author Thierry Boileau
     */
    ...
    private static final CharacterEntitySolver html40Entities;

    static {
        // Basic entities
        final List<CharacterEntity> xml10 = new ArrayList<>();
        ...
        // cf. http://www.w3.org/TR/xhtml1/DTD/xhtml-lat1.ent
        final List<CharacterEntity> htmlLat1 = new ArrayList<>();
        ...
        // cf. http://www.w3.org/TR/xhtml1/DTD/xhtml-symbol.ent
        final List<CharacterEntity> htmlSymbol = new ArrayList<>();
        ...
        // cf. http://www.w3.org/TR/xhtml1/DTD/xhtml-special.ent
        final List<CharacterEntity> htmlSpecial = new ArrayList<>();
        ...
        for (CharacterEntity entity : xml10) {
            html40Entities.add(entity.numericValue(), entity.name());
        }
     ...
     *
     * @param string The string to encode.
     * @return The String encoded with the Latin1 character set as an array of bytes.
     */
     ...
     * @return The converted {@link String} according to the HTML 4.0 encoding rules.
     */
    ...
    /**
     * Returns the given {@link String} decoded according to the HTML 4.0 decoding rules.
     *
     * @param str The {@link String} to decode.
     * @return The given {@link String} decoded according to the HTML 4.0 decoding rules.
     */
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (c == '&') {
                ...
                if (semicolonIndex != -1) {
                    ...
                    i = ampersandIndex - 1; // put the index to read the "&" character
                } else {
     ...
     * forms of methods like {@link String#toUpperCase} either.
     *
     * @param string a string reference to check
