 ...
 *
 * <p>Throws {@link UnsupportedOperationException} when mutable methods are invoked.
 *
...
public final class ImmutableDate extends Date {
    ...
    /**
     * As an ImmutableDate is immutable, this method throws an UnsupportedOperationException
     * exception.
     */
    @Override
