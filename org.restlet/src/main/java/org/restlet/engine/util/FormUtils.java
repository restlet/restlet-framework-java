...
public class FormUtils {
     ...
     * @param decode If true, the name and values are decoded with the given {@link CharacterSet},
     *     if false, than nothing is decoded.
     * @param characterSet The supported character encoding.
     * @return The created parameter.
     */
    public static Parameter create(
            CharSequence name, CharSequence value, boolean decode, CharacterSet characterSet) {
    ...
    public static Parameter getFirstParameter(
            String query, String name, CharacterSet characterSet, char separator, boolean decode)
            throws IOException {
     ...
     * @param characterSet The supported character encoding.
     * @param separator The separator character to append between parameters.
     * @param decode Indicates if the parameters should be decoded using the given character set. s
     *     * @return The parameter value or list of values.
     * @throws IOException If the parameters could not be read.
     */
     ...
     * @throws IOException If the parameters could not be read.
     */
    public static void getParameters(Representation post, Map<String, Object> parameters)
            throws IOException {
        if (!post.isAvailable()) {
            throw new IllegalStateException(
                    "The Web form cannot be parsed as no fresh content is available. If this entity has been already read once, caching of the entity is required");
    ...
    public static boolean isParameterFound(Parameter searchedParam, MediaType mediaRange) {
        ...
        for (Iterator<Parameter> iter = mediaRange.getParameters().iterator();
                !result && iter.hasNext(); ) {
