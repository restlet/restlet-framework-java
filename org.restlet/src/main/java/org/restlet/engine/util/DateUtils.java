...
public final class DateUtils {
    ...
    public static final List<String> FORMAT_ISO_8601 =
            unmodifiableList("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");

    /**
     * Common date format (RFC 822). Patterns: "EEE, dd MMM yy HH:mm:ss z" or "EEE, dd MMM yy HH:mm
     * z", "dd MMM yy HH:mm:ss z" or "dd MMM yy HH:mm z".
     */
    ...
    public static String format(final Date date) {
        return format(date, DateUtils.FORMAT_RFC_1123.getFirst());
    }
    ...
    public static String format(final Date date, final List<String> formats) {
        return format(date, formats != null ? formats.getFirst() : null);
    }
    ...
    public static String format(final Date date, final String format) {
        ...
        final java.text.DateFormat formatter;

        if (FORMAT_RFC_3339.getFirst().equals(format)) {
