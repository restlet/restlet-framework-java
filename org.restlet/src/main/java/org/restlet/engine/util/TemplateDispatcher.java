...
public class TemplateDispatcher extends Filter {
    ...
    /**
     * If the response entity comes back with no identifier, automatically set the request's
     * resource reference's identifier. This is very useful to resolve relative references in XSLT,
     * for example.
     */
    @Override
