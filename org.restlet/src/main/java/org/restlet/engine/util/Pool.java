...
public abstract class Pool<T> {
    ...
    /**
     * Constructor. Pre-creates the minimum number of objects if needed using the {@link
     * #preCreate(int)} method.
     *
    ...
    /**
     * Pre-creates the initial objects using the {@link #createObject()} method and check them in
     * the pool using the {@link #checkin(Object)} method.
     *
