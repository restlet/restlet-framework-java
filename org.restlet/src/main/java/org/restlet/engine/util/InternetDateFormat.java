...
/**
 * This class handles Internet date/time strings in accordance with RFC 3339. It provides static
 * methods to convert from various Java constructs (long, Date, and Calendar) to RFC 3339 format
 * strings and to parse these strings back into the same Java constructs.
 *
 * <p>In addition to the static utility methods, this class also wraps a Calendar object allowing
 * this class to be used as a value object in place of a Java construct.
 *
 * <p>Strings are parsed in accordance with the RFC 3339 format:
 *
 * <pre>
 * YYYY-MM-DD(T|t|\s)hh:mm:ss[.ddd][tzd]
 * </pre>
 *
 * The <code>tzd</code> represents the time zone designator and is either an upper or lower case 'Z'
 * indicating UTC or a signed <code>hh:mm</code> offset.
 *
...
public class InternetDateFormat extends DateFormat {
    ...
    /**
     * Returns the current date and time as an RFC 3339 date/time string using the UTC (Z) time
     * zone.
     *
    ...
    /**
     * Returns the current date and time as an RFC 3339 date/time string using the specified time
     * zone.
     *
    ...
    /**
     * Our private parse utility that parses the string, clears the calendar, and then sets the
     * fields.
     *
    ...
    /**
     * Converts the specified Calendar object to an RFC 3339 date/time string. Unlike the toString
     * methods for Date and long, no additional variant of this method taking a time zone is
     * provided since the time zone is built into the Calendar object.
     *
    ...
    /**
     * Converts the specified Date object to an RFC 3339 date/time string using the UTC (Z) time
     * zone.
     *
    ...
    /**
     * Converts the specified Date object to an RFC 3339 date/time string using the specified time
     * zone.
     *
     * @param date the Date object
     * @param zone the time zone to use
    ...
    /**
     * Converts the specified millisecond time value to an RFC 3339 date/time string using the UTC
     * (Z) time zone.
     *
    ...
    /**
     * Converts the specified millisecond time value to an RFC 3339 date/time string using the
     * specified time zone.
     *
     * @param time the millisecond time value
     * @param zone the time zone to use
    ...
    /**
     * Creates a new InternetDateFormat object from the specified Date object using the UTC (Z) time
     * zone.
     *
     * @param date the Date object
    ...
    /**
     * Creates a new InternetDateFormat object from the specified Date object using the specified
     * time zone.
     *
     * @param date the Date object
     * @param zone the time zone to use
    ...
    /**
     * Creates a new InternetDateFormat object from the specified millisecond time value using the
     * UTC (Z) time zone.
     *
     * @param time the millisecond time value
     * @return the InternetDateFormat object
    ...
    /**
     * Creates a new InternetDateFormat object initialized from a Calendar object. The specified
     * calendar object is cloned thereby isolating this InternetDateFormat object from any changes
     * made to the specified calendar object after calling this constructor.
     *
     * @param cal the Calendar object
     */
    ...
    /**
     * Creates a new InternetDateFormat object initialized from a Date object using the UTC (Z) time
     * zone.
     *
     * @param date the Date object
     */
    ...
    /**
     * Creates a new InternetDateFormat object initialized from a Date object using the specified
     * time zone.
     *
     * @param date the Date object
     * @param zone the time zone to use
    ...
    /**
     * Creates a new InternetDateFormat object initialized from a millisecond time value using the
     * UTC (Z) time zone.
     *
     * @param time the millisecond time value
     */
    ...
    /**
     * Creates a new InternetDateFormat object set to the current time using the specified time
     * zone.
     *
     * @param zone the time zone to use
     */
