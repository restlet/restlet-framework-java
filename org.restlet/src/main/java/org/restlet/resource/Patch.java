...
/**
 * Annotation for methods that apply submitted representations as a patch. Its semantics are
 * equivalent to an HTTP PATCH method. Note that your method must have one input parameter if you
 * want it to be selected for requests containing an entity.<br>
 * <br>
 * Example:
 *
 * <pre>
