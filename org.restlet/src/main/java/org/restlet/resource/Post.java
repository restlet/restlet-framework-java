...
/**
 * Annotation for methods that accept submitted representations. Its semantics are equivalent to an
 * HTTP POST method. Note that your method must have one input parameter if you want it to be
