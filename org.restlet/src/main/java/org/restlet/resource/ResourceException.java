...
public class ResourceException extends RuntimeException {
    ...
    /** The request associated with this exception. Could be null. */
    private transient Request request;

    /** The response associated with this exception. Could be null. */
    ...
    public ResourceException(
            int code, String reasonPhrase, String description, String uri, Throwable cause) {
     ...
     */
    public ResourceException(
            int code, Throwable throwable, String reasonPhrase, String description) {
    ...
    /**
     * Constructor that set the status to {@link org.restlet.data.Status#SERVER_ERROR_INTERNAL}
     * including the related error or exception.
     *
     * @param cause The wrapped cause error or exception.
     */
    ...
    /**
     * Returns the request associated with this exception.
     *
     * @return The request associated with this exception.
     */
    ...
    /**
     * Returns the status associated with this exception.
     *
