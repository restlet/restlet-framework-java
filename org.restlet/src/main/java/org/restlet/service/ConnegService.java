...
/**
 * Application service negotiating the preferred resource variants. This service is leveraged by
 * server-side and client-side content negotiation, annotated method dispatching, and so on.
 *
...
public class ConnegService extends Service {
    ...
    /**
     * Indicates if the conneg algorithm should strictly respect client preferences or be more
     * flexible.
     */
    ...
    /**
     * Returns the best variant representation for a given resource according the the client
     * preferences.<br>
    ...
    public Variant getPreferredVariant(
            List<? extends Variant> variants, Request request, MetadataService metadataService) {
        Conneg conneg =
                isStrict()
                        ? new StrictConneg(request, metadataService)
    ...
    /**
     * Indicates if the conneg algorithm should strictly respect client preferences or be more
     * flexible. Value is false by default.
     *
     * @return True if the conneg algorithm should strictly respect client preferences.
     */
     ...
     * flexible.
     *
     * @param strict True if the conneg algorithm should strictly respect client preferences.
     */
