...
/**
 * Application service tunneling request method or client preferences. The tunneling can use query
 * parameters, file-like extensions, and specific headers. This is particularly useful for
 ...
 *
 * <br>
 * The client preferences can also be updated according to the user agent properties (its name,
 * version, operating system, or other) available via the {@link ClientInfo#getAgentAttributes()}
 * method. Check the {@link #isUserAgentTunnel()} method.<br>
 * <br>
 * The list of new media type preferences is loaded from a property file called "accept.properties"
 * located in the classpath in the subdirectory "org/restlet/service". This property file is
 * composed of blocks of properties. One "block" of properties starts either with the beginning of
 * the properties file or with the end of the previous block. One block ends with the "acceptNew"
 * property which contains the value of the new Accept header. Here is a sample block.<br>
 *
 * <pre>
 * agentName: firefox
 ...
 * </pre>
 *
 * Each declared property is a condition that must be filled to update the client preferences. For
 * example, "agentName: firefox" expresses the fact this block concerns only "firefox" clients. <br>
 * <br>
 * The "acceptOld" property allows checking the value of the current "Accept" header. If it equals
 * to the value of the "acceptOld" property or if the "acceptOld" property is empty, then the
 * preferences will be updated. This can be useful for AJAX clients that look like their browser
 * (same agentName, agentVersion, etc.) but can provide their own "Accept" header.
 *
...
public class TunnelService extends Service {
     ...
     *
     * @param enabled True if the service has been enabled.
     * @param methodTunnel Indicates if the method can be tunneled using a query parameter.
     * @param preferencesTunnel Indicates if the client preferences can be tunneled using query
     *     parameters or file-like extensions or user agent string.
    ...
    /**
     * Indicates if the request from a given client can be tunneled. The default implementation
     * always returns true. This could be customized to restrict the usage of the tunnel service.
     *
    ...
    /**
     * Indicates if the client preferences can be tunneled via the extensions. Returns false by
     * default.
     *
    ...
    /**
     * Indicates if the client preferences can be tunneled via the query parameters or via file
     * extensions. Returns true by default.
     *
    ...
    /**
     * Indicates if the method and client preferences can be tunneled via query parameters or file
     * extensions. Returns true by default.
     *
    ...
    /**
     * Indicates if the client preferences can be tunneled according to the user agent. Returns
     * false by default.
     *
     * @return True if the client preferences can be tunneled according to the user agent.
     */
     ...
     *
     * @param extensionTunnel True if the client preferences can be tunneled via the extensions.
     * @see Request#getOriginalRef()
     */
     ...
     * Indicates if the method and client preferences can be tunneled via query parameters.
     *
     * @param queryTunnel True if the method and client preferences can be tunneled via query
     *     parameters.
     */
     ...
     *
     * @param userAgentTunnel True if the client preferences can be tunneled according to the user
     *     agent.
     */
