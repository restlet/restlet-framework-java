...
/**
 * Application service automatically decoding or uncompressing received entities. This service works
 * both for received requests entities on the server-side and received response entities on the
 * client-side.
 *
