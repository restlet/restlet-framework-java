...
/**
 * Generic service associated with a component or an application. The life cycle of a service is
 * tightly related to the one of the associated component or application.<br>
 * <br>
 * If you want to use a specific service, you can always disable it before it is actually started
 * via the {@link #setEnabled(boolean)} method.
 *
...
public abstract class Service {
     ...
     */
    protected Service(boolean enabled) {
        this.context = null;
