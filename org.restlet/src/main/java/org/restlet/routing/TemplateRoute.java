 ...
 * associated Router to determine the most appropriate Restlet for a given call. The routing is
 * based on a reference template.<br>
 * <br>
...
public class TemplateRoute extends Route {
    /**
     * Indicates whether the query part should be taken into account when matching a reference with
     * the template.
     */
    ...
    /**
     * Constructor. The URIs will be matched against the template using the {@link
     * Template#MODE_STARTS_WITH} matching mode. This can be changed by getting the template and
     * calling {@link Template#setMatchingMode(int)} with {@link Template#MODE_EQUALS} for exact
     * matching.
     *
    ...
    /**
     * Allows filtering before its handling by the target Restlet. By default, it parses the
     * template variable, adjusts the base reference of the target resource's reference.
     *
    ...
    protected int beforeHandle(Request request, Response response) {
        ...
        if (getTemplate() != null) {
            String remainingPart =
                    request.getResourceRef().getRemainingPart(false, isMatchingQuery());
     ...
     * the template.
     *
     * @return True if the query part of the reference should be taken into account, false
     *     otherwise.
     */
     ...
     *
     * @param matchingQuery True if the matching should be done with the query string, false
     *     otherwise.
     */
    ...
    public String toString() {
        return "\""
                + ((getTemplate() == null) ? super.toString() : getTemplate().getPattern())
                + "\" -> "
