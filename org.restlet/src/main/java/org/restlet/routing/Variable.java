...
public final class Variable {
    ...
    /**
     * Default constructor. Type is TYPE_ALL, default value is "", required is true, and fixed is
     * false.
     */
    public Variable() {
     ...
     *
     * @param type The type of variable. See TYPE_* constants.
     * @param defaultValue The default value to use if the key couldn't be found in the model.
     * @param required Indicates if the variable is required or optional.
     * @param fixed Indicates if the value is fixed, in which case the "defaultValue" property is
     *     always used.
     */
     ...
     *
     * @return True if the value is fixed, in which case the "defaultValue" property is always used.
     */
