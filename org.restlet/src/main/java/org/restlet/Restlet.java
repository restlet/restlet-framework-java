...
/**
 * Uniform class that provides a context and life cycle support. It has many subclasses that focus
 * on specific ways to process calls. The context property is typically provided by a parent
 * Component as a way to encapsulate access to shared features such as logging and client
 * connectors.<br>
 * <br>
...
public abstract class Restlet implements Uniform {
     ...
     */
    protected Restlet(Context context) {
    ...
    /**
     * Creates a new finder instance based on the "targetClass" property. If none is define, the
     * {@link Application#createFinder(Class)} method is invoked if available, otherwise the {@link
     * org.restlet.resource.Finder#createFinder(Class, Class, Context, Logger)} method is called
     * with the {@link org.restlet.resource.Finder} class as parameter.
     *
     * @param resourceClass The target {@link org.restlet.resource.ServerResource} class to find.
    ...
    public org.restlet.resource.Finder createFinder(
        ...
        if (getFinderClass() != null) {
            result =
                    org.restlet.resource.Finder.createFinder(
                            resourceClass, getFinderClass(), getContext(), getLogger());
            ...
            result =
                    org.restlet.resource.Finder.createFinder(
                            resourceClass,
                            org.restlet.resource.Finder.class,
                            getContext(),
                            getLogger());
        }
    ...
    /**
     * Returns the finder class used to instantiate resource classes. By default, it returns the
     * {@link org.restlet.resource.Finder} class. This property is leveraged by {@link
     * Application#setOutboundRoot(Class)} and {@link Application#setInboundRoot(Class)} methods.
     *
    ...
    /**
     * Sets the finder class to instantiate. This property is leveraged by {@link
     * Application#setOutboundRoot(Class)} and {@link Application#setInboundRoot(Class)} methods.
     *
    ...
    /**
     * Starts the Restlet. By default, it only sets the "started" internal property to true.
     *
     * <p>WARNING: this method must be called at the end of the starting process by subclasses,
     * otherwise concurrent threads could enter into the call handling logic too early.
     *
     * @throws Exception
     */
    ...
    /**
     * Stops the Restlet. By default, it only sets the "started" internal property to false.
     *
     * <p>WARNING: this method must be called at the beginning of the stopping process by
     * subclasses, otherwise concurrent threads could continue to (improperly) handle calls.
     *
     * @throws Exception
     */
