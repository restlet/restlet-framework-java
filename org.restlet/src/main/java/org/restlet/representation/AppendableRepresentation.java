...
public class AppendableRepresentation extends StringRepresentation implements Appendable {
    ...
    /**
     * Constructor. The following metadata is used by default: no language and the ISO-8859-1
     * character set.
     *
     * @param text The string value.
    ...
    /**
     * Constructor. The following metadata is used by default: ISO-8859-1 character set.
     *
     * @param text The string value.
     * @param mediaType The media type.
     * @param language The language.
