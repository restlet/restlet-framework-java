...
/**
 * Information about a representation. Those metadata don't belong to the parent {@link Variant}
 * class, however they are important for conditional method processing. The advantage over the
 * complete {@link Representation} class is that it is much lighter to create.
 *
...
public class RepresentationInfo extends Variant {
    ...
    /**
     * Returns the last date when this representation was modified. If this information is not
     * known, returns null.<br>
     * <br>
    ...
    /**
     * Sets the last date when this representation was modified. If this information is not known,
     * pass null.<br>
     * <br>
     * Note that when used with HTTP connectors, this property maps to the "Last-Modified" header.
     *
