...
/**
 * Representation based on a BIO output stream. This class is a good basis to write your own
 ...
 * Representation.write(OutputStream) method. This method will later be called back by the
 * connectors when the actual representation's content is needed.
 *
...
public abstract class OutputRepresentation extends StreamRepresentation {
     ...
     */
    protected OutputRepresentation(MediaType mediaType) {
        super(mediaType);
    }
     ...
     */
    protected OutputRepresentation(MediaType mediaType, long expectedSize) {
        super(mediaType);
