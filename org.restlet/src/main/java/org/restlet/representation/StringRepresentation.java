...
/**
 * Represents a Unicode string that can be converted to any character set supported by Java.
 *
...
public class StringRepresentation extends CharacterRepresentation {
    ...
    /**
     * Constructor. The following metadata is used by default: "text/plain" media type, no language,
    ...
    /**
     * Constructor. The following metadata is used by default: no language and the UTF-8 character
     * set.
     *
     * @param text The string value.
    ...
    /**
     * Constructor. The following metadata is used by default: UTF-8 character set.
     *
     * @param text The string value.
     * @param mediaType The media type.
     * @param language The language.
    ...
    public StringRepresentation(
            CharSequence text, MediaType mediaType, Language language, CharacterSet characterSet) {
        super(mediaType);
    ...
    public InputStream getStream() throws IOException {
        CharacterSet charset =
                getCharacterSet() == null ? CharacterSet.ISO_8859_1 : getCharacterSet();
        return new ByteArrayInputStream(getText().getBytes(charset.getName()));
    }
