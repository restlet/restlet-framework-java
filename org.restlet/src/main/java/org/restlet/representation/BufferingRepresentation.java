...
/**
 * Representation capable of buffering the wrapped representation. This is useful when you want to
 * prevent chunk encoding from being used for dynamic representations or when you want to reuse a
 * transient representation several times.<br>
 * <br>
 * Be careful as this class could create potentially very large byte buffers in memory that could
...
public class BufferingRepresentation extends WrapperRepresentation {
    ...
    public long getSize() {
        ...
        try {
            ...
            Context.getCurrentLogger()
                    .log(Level.WARNING, "Unable to buffer the wrapped representation", e);
        }
    ...
    public String getText() throws IOException {
        ...
        if (getBuffer() != null) {
            return (getCharacterSet() != null)
                    ? new String(getBuffer(), getCharacterSet().toCharset())
    ...
    public boolean isAvailable() {
        try {
            ...
            Context.getCurrentLogger()
                    .log(Level.FINER, "Unable to buffer the wrapped representation", e);
        }
