...
/**
 * Request wrapper. Useful for application developer who need to enrich the request with application
 * related properties and behavior.
 *
...
public class WrapperRequest extends Request {
     ...
     * the message. This is an easier alternative to the creation of a wrapper instance around the
     * whole message.<br>
     * <br>
     ...
     * </table>
     *
     * Adding standard HTTP headers is forbidden because it could conflict with the connector's
     * internal behavior, limit portability, or prevent future optimizations.</td>
     *
    ...
    /**
     * Returns the protocol by first returning the baseRef.schemeProtocol property if it is set, or
     * the resourceRef.schemeProtocol property otherwise.
     *
     ...
     *
     * @param accessControlRequestHeaders The access control request headers of the target resource.
     */
    @Override
     ...
     *
     * @param accessControlRequestMethod The access control request method of the target resource.
     */
    @Override
