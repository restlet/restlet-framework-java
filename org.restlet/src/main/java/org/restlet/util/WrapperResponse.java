...
/**
 * Request wrapper. Useful for developers who need to enrich the request with application-related
...
public class WrapperResponse extends Response {
    ...
    /**
     * Returns the set of methods allowed on the requested resource. This property only has to be
     * updated when a status CLIENT_ERROR_METHOD_NOT_ALLOWED is set.
     *
     ...
     *
     * @return The list of authentication requests sent by an origin server to a client.
     */
    @Override
    ...
    /**
     * Returns the set of selecting dimensions on which the response entity may vary. If some
     * server-side content negotiation is done, this set should be properly updated, other it can be
     * left empty.
     *
     ...
     * content must exists and have some available data.
     *
     ...
     *
     * @param requests The list of authentication requests sent by a proxy to a client.
     */
    @Override
