 ...
 * subclassing. By default, it wraps a thread-safe {@link Vector} instance.
 *
...
public class WrapperList<E> implements List<E>, Iterable<E> {
    ...
    public WrapperList(int initialCapacity) {
        this(new Vector<>(initialCapacity));
    }
    ...
    /**
     * Appends the elements of the specified collection at the end of this list.
     *
    ...
    /**
     * Inserts the elements of the specified collection into this list at the specified position.
     *
     * @param index The insertion position.
     ...
     *
     * @return A list iterator of the elements in this list (in a proper sequence).
     */
    ...
    /**
     * Returns a list iterator of the elements in this list (in a proper sequence), starting at the
    ...
    /**
     * Returns an array containing all the elements in this list in a proper sequence; the runtime
