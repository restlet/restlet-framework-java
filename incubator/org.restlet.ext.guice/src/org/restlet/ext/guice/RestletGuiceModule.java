 ...
 */
public class RestletGuiceModule extends AbstractModule implements FinderFactory {

    /**
     * Creates a FinderFactoryModule that will install the given modules.
     */
    public RestletGuiceModule(Module... modules) {
     ...
     * Creates a FinderFactoryModule that will install the given modules.
     */
    public RestletGuiceModule(Iterable<? extends Module> modules) {
    ...
    class KeyFinder extends Finder {
        ...
        protected final Injector getInjector() {
            ...
            if (inj == null) {
                synchronized (RestletGuiceModule.this) {
                    inj = injector;
                    if (inj == null) {
                        inj = Guice.createInjector(RestletGuiceModule.this);
                    }
                }
            }
            return inj;
