 ...
 */
public class SipConnectedRequest extends SipRequest {
     ...
     *            The protocol version.
     */
    public SipConnectedRequest(Context context, Connection<Server> connection,
     ...
     *            The request to copy.
     */
    public SipConnectedRequest(SipConnectedRequest request) {
        super(request);
