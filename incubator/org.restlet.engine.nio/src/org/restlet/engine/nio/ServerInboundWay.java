...
public class ServerInboundWay extends InboundWay {
    ...
    protected ConnectedRequest createRequest(Context context,
            Connection<?> connection, String methodName, String resourceUri,
            String version) {
        return new ConnectedRequest(getConnection().getHelper().getContext(),
                getConnection(), methodName, resourceUri, version);
    }
