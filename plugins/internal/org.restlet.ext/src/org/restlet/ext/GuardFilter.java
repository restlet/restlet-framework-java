...
public class GuardFilter extends Filter
{
	 ...
	 */
	@Deprecated
	public GuardFilter(Context context, boolean authenticate, ChallengeScheme scheme, String realm, boolean authorize)
	{
	}
	 ...
	 */
	public GuardFilter(Context context, ChallengeScheme scheme, String realm)
	{
		super(context);
