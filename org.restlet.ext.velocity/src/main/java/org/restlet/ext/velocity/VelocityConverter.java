...
/**
 * Converter between the Velocity Template objects and Representations. The adjoined data model is
...
public class VelocityConverter extends ConverterHelper {
    ...
    public Representation toRepresentation(Object source, Variant target, Resource resource) {
        ...
        if (source instanceof Template template) {
            TemplateRepresentation tr = new TemplateRepresentation(template, target.getMediaType());
