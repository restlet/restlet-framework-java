...
Caption "@restlet-engine@ @version-full@"
BrandingText " "
...
OutFile @dist-base@/restlet-@restlet-edition@-@version-compact@.exe
InstallDir "$PROGRAMFILES\Noelios\Restlet-@restlet-edition@-@version-minor@"
CRCCheck on
XPStyle on
ShowInstDetails hide
ShowUnInstDetails hide
VIProductVersion "@version-minor@.0.0"
VIAddVersionKey ProductName "@restlet-edition-label@"
...
Section -post SEC0001
    ...
    CreateDirectory "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}"
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Uninstall.lnk" $INSTDIR\uninstall.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Home page.lnk" "http://www.restlet.org"
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Restlet API (javadocs).lnk" "$INSTDIR\docs\api\index.html"
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Restlet Extensions (javadocs).lnk" "$INSTDIR\docs\ext\index.html"
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Restlet Engine (javadocs).lnk" "$INSTDIR\docs\engine\index.html"
    !insertmacro MUI_STARTMENU_WRITE_END
    WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)${VERSION}" DisplayName "Restlet Engine (@restlet-edition@) @version-full@"
...
Section un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Uninstall.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Home page.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Restlet API (javadocs).lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Restlet Extensions (javadocs).lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}\Restlet Engine (javadocs).lnk"
    RmDir  /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Restlet-@restlet-edition@ ${VERSION}"
    ...
    ${If} ${FileExists} "$INSTDIR\uninstall.log"
      ...
      ; Remove the installation directory if it is empty
       ...
       StrCmp "$INSTDIR" "$PROGRAMFILES\Noelios\Restlet-@editionKey@-@version-minor@" 0 +2
