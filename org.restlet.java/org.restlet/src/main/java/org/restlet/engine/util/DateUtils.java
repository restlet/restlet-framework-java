...
public final class DateUtils {
	...
	/**
	 * Obsoleted HTTP date format (ANSI C asctime() format). Pattern: "EEE MMM dd
	 * HH:mm:ss yyyy".
	 */
	public static final List<String> FORMAT_ASC_TIME = unmodifiableList("EEE MMM dd HH:mm:ss yyyy");

	/**
	 * Obsoleted HTTP date format (RFC 1036). Pattern: "EEEE, dd-MMM-yy HH:mm:ss
	 * zzz".
	 */
	public static final List<String> FORMAT_RFC_1036 = unmodifiableList("EEEE, dd-MMM-yy HH:mm:ss zzz");

	/**
	 * Preferred HTTP date format (RFC 1123). Pattern: "EEE, dd MMM yyyy HH:mm:ss
	 * zzz".
	 */
	...
	/**
	 * Common date format (RFC 822). Patterns: "EEE, dd MMM yy HH:mm:ss z" or "EEE,
	 * dd MMM yy HH:mm z", "dd MMM yy HH:mm:ss z" or "dd MMM yy HH:mm z".
	 */
	public static final List<String> FORMAT_RFC_822 = unmodifiableList("EEE, dd MMM yy HH:mm:ss z",
			"EEE, dd MMM yy HH:mm z", "dd MMM yy HH:mm:ss z", "dd MMM yy HH:mm z");
	...
	/**
	 * Parses a formatted date into a Date object using the default HTTP format (RFC
	 * 1123).
	 * 
	...
	/**
	 * Helper method to help initialize this class by providing unmodifiable lists
	 * based on arrays.
	 * 
