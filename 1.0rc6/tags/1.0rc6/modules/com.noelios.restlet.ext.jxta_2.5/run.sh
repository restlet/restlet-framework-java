...
lib=${libraries}/net.jxta_2.5/net.jxta.jar:${libraries}/net.jxta_2.5/net.jxta.ext.network.jar:${libraries}/net.jxta_2.5/net.jxta.ext.configuration.jar:${libraries}/javax.servlet_2.4/javax.servlet.jar:${libraries}/net.jxta_2.5/org.mortbay.jetty.jar:${libraries}/org.bouncycastle_1.34/org.bouncycastle-jdk14.jar
