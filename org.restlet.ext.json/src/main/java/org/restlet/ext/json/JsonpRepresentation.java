...
/**
 * Wrappers that adds a JSONP header and footer to JSON representations. The goal is to make them
 * accessible to web browser without restriction from single origin policies.
 *
...
public class JsonpRepresentation extends WriterRepresentation {
     ...
     * Constructor.
     *
     * @param callback The name of the JavaScript callback method.
     * @param status The actual status code.
     * @param wrappedRepresentation
     */
    public JsonpRepresentation(
            String callback, Status status, Representation wrappedRepresentation) {
