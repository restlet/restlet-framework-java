 ...
 * @author Cyril Lakech
 */
class JsonpRepresentationTestCase {
    ...
    @Test
    void testGetSizeJson() {
        JsonpRepresentation jsonpRepresentation =
                new JsonpRepresentation(CALLBACK, SUCCESS_OK, new JsonRepresentation(JSON_SAMPLE));
        ...
        long expected =
                JSON_SAMPLE.length()
                        ...
                        + CALLBACK.length()
                        + JSONP_STATUS_BODY.length();

        assertEquals(expected, actual);
    }

    @Test
    void testGetSize_with_text_is_UNKNOWN_SIZE() {
        JsonpRepresentation jsonpRepresentation =
                new JsonpRepresentation(
                        CALLBACK,
                        SUCCESS_OK,
                        new StringRepresentation(JSON_SAMPLE, MediaType.TEXT_HTML));
    ...
    @Test
    void testWrite_with_text_then_apostrophe_are_escaped() throws Exception {
        JsonpRepresentation jsonpRepresentation =
                new JsonpRepresentation(
                        CALLBACK,
                        SUCCESS_OK,
