...
public enum Statuses implements Status
{
   ...
   SUCCESS_OK, SUCCESS_CREATED, SUCCESS_ACCEPTED, SUCCESS_NON_AUTHORITATIVE, SUCCESS_NO_CONTENT, SUCCESS_RESET_CONTENT, SUCCESS_PARTIAL_CONTENT, SUCCESS_MULTI_STATUS,

   REDIRECTION_MULTIPLE_CHOICES, REDIRECTION_MOVED_PERMANENTLY, REDIRECTION_MOVED_TEMPORARILY, REDIRECTION_FOUND, REDIRECTION_SEE_OTHER, REDIRECTION_NOT_MODIFIED, REDIRECTION_USE_PROXY, REDIRECTION_TEMPORARY_REDIRECT,

   CLIENT_ERROR_BAD_REQUEST, CLIENT_ERROR_UNAUTHORIZED, CLIENT_ERROR_PAYMENT_REQUIRED, CLIENT_ERROR_FORBIDDEN, CLIENT_ERROR_NOT_FOUND, CLIENT_ERROR_METHOD_NOT_ALLOWED, CLIENT_ERROR_NOT_ACCEPTABLE, CLIENT_ERROR_PROXY_AUTHENTIFICATION_REQUIRED, CLIENT_ERROR_REQUEST_TIMEOUT, CLIENT_ERROR_CONFLICT, CLIENT_ERROR_GONE, CLIENT_ERROR_LENGTH_REQUIRED, CLIENT_ERROR_PRECONDITION_FAILED, CLIENT_ERROR_REQUEST_ENTITY_TOO_LARGE, CLIENT_ERROR_REQUEST_URI_TOO_LONG, CLIENT_ERROR_UNSUPPORTED_MEDIA_TYPE, CLIENT_ERROR_REQUESTED_RANGE_NOT_SATISFIABLE, CLIENT_ERROR_EXPECTATION_FAILED, CLIENT_ERROR_UNPROCESSABLE_ENTITY, CLIENT_ERROR_LOCKED, CLIENT_ERROR_FAILED_DEPENDENCY,

   SERVER_ERROR_INTERNAL, SERVER_ERROR_NOT_IMPLEMENTED, SERVER_ERROR_BAD_GATEWAY, SERVER_ERROR_SERVICE_UNAVAILABLE, SERVER_ERROR_GATEWAY_TIMEOUT, SERVER_ERROR_HTTP_VERSION_NOT_SUPPORTED, SERVER_ERROR_INSUFFICIENT_STORAGE;
