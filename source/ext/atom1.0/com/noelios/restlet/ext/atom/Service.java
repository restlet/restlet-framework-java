...
public class Service extends SaxRepresentation
{
	...
	{
		this(Manager.createClient(Protocols.HTTP, "Atom HTTP Client"), serviceUri);
	}
	...
	{
		this(Manager.createClient(Protocols.HTTP, "Atom HTTP Client"), serviceUri, xmlService);
	}
	 ...
	 * @throws IOException
	 */
	public Service(Client client, String serviceUri, Representation xmlService) throws IOException
	{
		super(xmlService);
		this.client = client;
		...
		public void startElement(String uri, String localName, String qName, Attributes attrs) throws SAXException
		{
			if(uri.equalsIgnoreCase(NAMESPACE))
			{
				...
				else if(localName.equalsIgnoreCase("workspace"))
				{
					if(state == IN_SERVICE)
					{
						currentWorkspace = new Workspace(this.currentService, attrs.getValue("title"));
						state = IN_WORKSPACE;
					}
				}
				else if(localName.equalsIgnoreCase("collection"))
				{
					...
					{
						currentCollection = new Collection(currentWorkspace, attrs.getValue("title"), attrs.getValue("href"));
						state = IN_COLLECTION;
					}
				}
