...
public class TemplateFilter extends Filter {
    ...
    /**
     * Returns the template data model common to all calls. If each call should have a specific
     * model, you should set this property to null.
     *
    ...
    /**
     * Sets the template data model common to all calls. If each call should have a specific model,
     * you should set this property to null.
     *
     * @param dataModel The template data model common to all calls.
     */
