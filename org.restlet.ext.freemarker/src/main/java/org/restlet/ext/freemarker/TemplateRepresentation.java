 ...
 *
 * @see <a href="https://freemarker.apache.org/">FreeMarker home page</a>
...
public class TemplateRepresentation extends WriterRepresentation {
     ...
     * @param templateRepresentation The template representation.
     * @return The template or null if not found.
     */
    public static Template getTemplate(
            Configuration config, Representation templateRepresentation) {
        try {
            ...
            if (templateRepresentation.getCharacterSet() != null) {
                return new Template(
                        "template",
                        templateRepresentation.getReader(),
                        config,
     ...
     * Constructor.
     *
     * @param templateRepresentation The FreeMarker template provided via a representation.
     * @param config The FreeMarker configuration.
     * @param mediaType The representation's media-type.
     */
    public TemplateRepresentation(
            Representation templateRepresentation, Configuration config, MediaType mediaType) {
     ...
     */
    public TemplateRepresentation(
            String templateName, Configuration config, Object dataModel, MediaType mediaType) {
