...
public class SpringHost extends VirtualHost {
    ...
    /**
     * Sets a route to attach. The keys are the URI template, and the value can be either Restlet
     * instance, {@link ServerResource} subclasse (as {@link Class} instances or as qualified class
     * names).
     *
     * @param path The attachment URI path.
     * @param route The route object to attach.
     */
    public void setAttachment(String path, Object route) {
        if (route instanceof Restlet restlet) {
    ...
    /**
     * Sets the map of routes to attach. The map keys are the URI templates, and the values can be
     * either Restlet instances, {@link ServerResource} subclasses (as {@link Class} instances or as
     * qualified class names).
     *
     * @param routes The map of routes to attach.
     */
    public void setAttachments(Map<String, Object> routes) {
        routes.forEach(this::setAttachment);
    }

    /**
     * Sets the default route to attach. The route can be either Restlet instances, {@link
     * ServerResource} subclasses (as {@link Class} instances or as qualified class names).
     *
     * @param route The default route to attach.
     */
