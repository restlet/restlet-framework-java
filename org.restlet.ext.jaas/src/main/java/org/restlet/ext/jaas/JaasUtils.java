...
public final class JaasUtils {
    ...
    /**
     * Creates a JAAS subject based on a given {@link ClientInfo}. It adds a {@link
     * ClientInfo#getUser()}, all the entries in {@link ClientInfo#getRoles()} and all other
     * principals in {@link ClientInfo#getPrincipals()}.
     *
     * @param clientInfo The client info to expose as a subject.
    ...
    /**
     * Creates a JAAS subject on the {@link ClientInfo} and uses it to run the action, using {@link
     * Subject#doAsPrivileged(Subject, PrivilegedAction, AccessControlContext)} . This uses a null
     * {@link AccessControlContext}.
     *
     * @param <T> the return type of the action.
     * @param clientInfo the client info from which to build as a subject.
     ...
     *
     * @param <T> the return type of the action.
     * @param clientInfo the client info from which to build a subject.
     * @param action the code to be run as the specified Subject.
