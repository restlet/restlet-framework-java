...
/**
 * Restlet log facade for the SLF4J {@link LoggerFactory}. To use SLF4J as the logging facade for
 * Restlet, you need to set the "org.restlet.engine.loggerFacadeClass" system property with the
...
public class Slf4jLoggerFacade extends LoggerFacade {
    ...
    /**
     * Returns an instance of {@link Slf4jLogger}, wrapping the result of {@link
