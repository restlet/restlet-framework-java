 ...
 */
public class RemoteAuthorizer extends Authorizer {
     ...
     */
    public RemoteAuthorizer(String validationURI, String authorizationURI) {
     ...
     *            url that should be invoked on errors
     */
    public RemoteAuthorizer(Reference validationRef, Reference authorizationRef) {
     ...
     *            validation url pointing to the auth server validation resource
     */
    public RemoteAuthorizer(Reference validationRef) {
