...
/**
 * Representation based on a simple string template. Note that the string value
...
public class StringTemplateRepresentation extends StreamRepresentation {
     ...
     */
    public StringTemplateRepresentation(CharSequence pattern,
            MediaType mediaType) {
     ...
     */
    public StringTemplateRepresentation(CharSequence pattern,
            String variableStart, String variableEnd, String instructionStart,
            String instructionEnd, MediaType mediaType) {
        this(pattern, variableStart, variableEnd, instructionStart,
                instructionEnd, new MapModel(), mediaType);
    }
    ...
    public StringTemplateRepresentation(CharSequence pattern,
            String variableStart, String variableEnd, String instructionStart,
            String instructionEnd, Model model, MediaType mediaType) {
        super(mediaType);
        setCharacterSet(CharacterSet.ISO_8859_1);
        ...
        if (value != null) {
            if (getCharacterSet() != null) {
                return new ByteArrayInputStream(value
                        .getBytes(getCharacterSet().getName()));
            } else {
