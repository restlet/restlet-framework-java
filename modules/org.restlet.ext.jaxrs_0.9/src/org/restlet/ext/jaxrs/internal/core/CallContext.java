...
public class CallContext implements javax.ws.rs.core.Request, HttpHeaders,
    ...
    private static class MatrixParamEncIter implements Iterator<String> {
        ...
        public boolean hasNext() {
            ...
            while ((this.matrixParamIter != null)
                    && this.matrixParamIter.hasNext()) {
                final Map.Entry<String, List<String>> entry = this.matrixParamIter
                        .next();
    ...
    private final LinkedList<Object> ancestorResources = new LinkedList<Object>();

    /** contains the current value of the ancestor resource URIs */
    private final LinkedList<String> ancestorResourceURIs = new LinkedList<String>();
    ...
    public void addForAncestor(Object resourceObject, String newUriPart) {
        ...
        if (this.lastAncestorResourceURI != null) {
            ...
            newUri.append(this.lastAncestorResourceURI);
        }
    ...
    public ResponseBuilder evaluatePreconditions(Date lastModified,
            EntityTag entityTag) {
        // NICE Vorbed. werden mit Conditions.getStatus() unterst�tzt.
    ...
    List<String> getAncestorResourceURIs() {
        return this.ancestorResourceURIs;
    }
    ...
    public String getAuthenticationScheme() {
        ...
        final ChallengeResponse challengeResponse = this.request
    ...
    public MediaType getMediaType() {
        if (this.mediaType == null) {
            final org.restlet.data.MediaType rmt = this.request.getEntity()
                    .getMediaType();
            final CharacterSet rCharSet = this.request.getEntity()
                    .getCharacterSet();
    ...
    public MultivaluedMap<String, String> getPathParameters() {
        if (this.pathParametersDecoded == null) {
            ...
            for (final Map.Entry<String, List<String>> entryEnc : interalGetPathParamsEncoded()
                ...
                final List<String> valuesDec = new ArrayList<String>(valuesEnc
                        .size());
    ...
    @Override
    public int hashCode() {
        return getBaseUriStr().hashCode() ^ this.getPathSegments().hashCode()
