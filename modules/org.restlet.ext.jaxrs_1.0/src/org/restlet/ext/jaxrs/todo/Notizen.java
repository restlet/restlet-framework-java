...
public class Notizen
{
    ...
    // REQUESTED JSR311: acceptedMediaTypes: IE and Firefox requests XML before HTML, so first XML will be returned to a browser. A browser should normal get HTML.
