...
import org.restlet.gae.engine.util.DefaultSaxHandler;
...
public class ComponentXmlParser {
            ...
            if ("component".equals(document.getFirstChild().getNodeName())) {
                ...
                for (int i = 0; i < childNodes.getLength(); i++) {
                    ...
                    if ("client".equals(childNode.getNodeName())) {
                        ...
                        if (item != null) {
                            getComponent().getStatusService().setOverwrite(
                                    getBoolean(item, true));
                        }
                    }
                }
    ...
    private void parseRouter(Router router, Node routerNode) {
        ...
        if (item != null) {
            router.setDefaultMatchQuery(getBoolean(item, getComponent()
                    .getInternalRouter().getDefaultMatchQuery()));
        }
