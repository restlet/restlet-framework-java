...
public class ThrowableSerializer {
    ...
    /**
     * Serialize {@link Throwable} properties to a Map using reflection. The
     * properties of {@link Throwable} class are ignored except if they are
     * overriden.
     * 
     * @param throwable
        ...
        try {
            ...
            for (PropertyDescriptor propertyDescriptor : propertyDescriptors) {
                properties.put(propertyDescriptor.getName(), propertyDescriptor
                        .getReadMethod().invoke(throwable));
            }
            return properties;
        } catch (Exception e) {
            throw new RuntimeException(
                    "Could not serialize properties of class "
