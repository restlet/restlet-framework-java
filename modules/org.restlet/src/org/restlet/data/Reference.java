 ...
 * "decode()" methods for this purpose.<br>
 * 
 ...
 * no dot-segments (the path segments "." and "..").<br>
 * 
 ...
 * reference, if any, and solves the dot-segments.<br>
 * 
 ...
 * various reference properties (URI components).<br>
 * 
 ...
 * the base reference, all relative references are still accurate.<br>
 * 
