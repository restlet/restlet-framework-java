 ...
 * following a {@link ChallengeRequest} sent by the origin server to the
 * client.<br>
 * <br>
...
public final class ChallengeResponse extends ChallengeMessage {
	...
	/**
	 * The {@link Request#getResourceRef()} value duplicated here in case a proxy
	 * changed it.
	 */
	 ...
	 * @param identifier       The user identifier, such as a login name or an
	 *                         access key.
	 * @param secret           The user secret, such as a password or a secret key,
	 *                         with no digest applied.
	 */
	 ...
	 * @param identifier       The user identifier, such as a login name or an
	 *                         access key.
	 * @param secret           The user secret used to compute the secret, with an
	 *                         optional digest applied.
	 * @param secretAlgorithm  The digest algorithm of the user secret (see
	 *                         {@link Digest} class).
	 */
	public ChallengeResponse(ChallengeRequest challengeRequest, Response response, String identifier, char[] secret,
			String secretAlgorithm) {
		this(challengeRequest.getScheme(), null, identifier, secret, secretAlgorithm, null, null, null, null, null,
				null, null, 0, 0L);
	 ...
	 *                          access key.
	 * @param secret            The user secret, such as a password or a secret key.
	 * @param secretAlgorithm   The digest algorithm name optionally applied on the
	 *                          user secret.
	 * @param realm             The authentication realm.
	 * @param quality           The chosen quality of protection.
	 * @param digestRef         The {@link Request#getResourceRef()} value
	 *                          duplicated here in case a proxy changed it.
	...
	public ChallengeResponse(ChallengeScheme scheme, String identifier, char[] secret, Series<Parameter> parameters) {
		this(scheme, parameters, identifier, secret, Digest.ALGORITHM_NONE, null, null, null, null, null, null, null, 0,
				0L);
	}
	...
	/**
	 * Returns the {@link Request#getResourceRef()} value duplicated here in case a
	 * proxy changed it.
	 * 
	 ...
	 * 
	 * @param secretDigestAlgorithm The digest algorithm name optionally applied on
	 *                              the user secret.
	 */
