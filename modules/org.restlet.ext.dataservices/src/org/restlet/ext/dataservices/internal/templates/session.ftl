...
<#compress>
/**
 * Generated by the generator tool for the ADO.NET Data Services extension for the Restlet framework.<br>
 * 
<#if metadata.metadataRef??> * @see <a href="${metadata.metadataRef}">Metadata of the target ADO.NET Data Services</a></#if>
 * 
 */
</#compress>
