...
public class Swagger2Translator {
     ...
     */
    private void fillPathOperations(Definition definition, Resource resource, Path pathSwagger) {
    ...
    private void fillOperationParameters(Definition definition, Resource resource, Operation operation, com.wordnik.swagger.models.Operation operationSwagger) {
...
//                queryParameterSwagger.setCollectionFormat("csv");
    ...
    private void fillOperationResponses(Definition definition, Operation operation, com.wordnik.swagger.models.Operation operationSwagger) {
    ...
    private void fillDefinitions(Definition definition, Swagger swagger) {
        for (Representation representation : definition.getContract().getRepresentations()) {
            ...
            if (representation.isRaw() || isPrimitiveType(representation.getName())) {
                continue;
            }
            ...
            for (Property property : representation.getProperties()) {
                ...
                // property type
                if (
                        property.getMaxOccurs() != null &&
                                (property.getMaxOccurs() > 1 || property.getMaxOccurs() == -1)
                        ) {
                    ArrayProperty arrayProperty = new ArrayProperty();
                    arrayProperty.setItems(newPropertyForType(property.getType()));
