...
public class AnalyticsModule extends Filter {
    public AnalyticsModule(AgentConfig agentConfig, ModulesSettings modulesSettings) {
        this(agentConfig, modulesSettings, null);
    }
    public AnalyticsModule(AgentConfig agentConfig, ModulesSettings modulesSettings, Context context) {
        super(context);
    }
}
