 ...
 */
public class FirewallUtils extends Filter {
     ...
     */
    public FirewallRule createHostDomainConcurrencyCounter(int limit) {
     ...
     * @return The associated rule.
     */
    public FirewallRule createHostDomainPeriodicCounter(int period, int limit) {
     ...
     * @return The associated rule.
     */
    public FirewallRule createIpAddressesBlackList(List<String> blackList) {
        FirewallCounterRule rule = new ConcurrentFirewallCounterRule(
     ...
     * @return The associated rule.
     */
    public FirewallRule createIpAddressesConcurrencyCounter(int limit) {
        FirewallCounterRule rule = new ConcurrentFirewallCounterRule(
                new IpAddressCountingPolicy());
        rule.addHandler(new BlockingHandler(new UniqueLimitPolicy(limit)));
        return rule;
     ...
     * @return The associated rule.
     */
    public FirewallRule createIpAddressesPeriodicCounter(int period, int limit) {
        FirewallCounterRule rule = new PeriodicFirewallCounterRule(period,
                new IpAddressCountingPolicy());
        rule.addHandler(new BlockingHandler(new UniqueLimitPolicy(limit)));
        return rule;
     ...
     * @return The associated rule.
     */
    public FirewallRule createIpAddressesWhiteList(List<String> whiteList) {
        FirewallCounterRule rule = new ConcurrentFirewallCounterRule(
                new IpAddressCountingPolicy());
        Map<String, Integer> map = new HashMap<String, Integer>();
     ...
     * @return The associated rule.
     */
    public FirewallRule createRolesConcurrencyCounter(
            Map<String, Integer> limitsPerRole) {
        return createRolesConcurrencyCounter(limitsPerRole, 0);
    }
     ...
     * @return The associated rule.
     */
    public FirewallRule createRolesPeriodicCounter(int period,
            Map<String, Integer> limitsPerRole) {
        return createRolesPeriodicCounter(period, limitsPerRole, 0);
    }
