...
public class Swagger2SpecificationRestlet extends Restlet {
     ...
     * {@link Swagger2Reader#SWAGGER_VERSION}
     */
    private String swaggerVersion = Swagger2Reader.SWAGGER_VERSION;
    ...
    public Representation getSwagger() {
        Swagger swagger = Swagger2Reader.getSwagger(getDefinition());
