...
public class JaxRsApplicationSwagger2SpecificationRestlet extends Restlet {
     ...
     *            The application.
     */
    public JaxRsApplicationSwagger2SpecificationRestlet Swagger2SpecificationRestlet(Application application) {
        this.application = application;
        return this;
    }
     ...
     *            The application.
     */
    public JaxRsApplicationSwagger2SpecificationRestlet setApplication(Application application) {
        this.application = application;
        return this;
    }
    /**
     ...
     *
     */
    public JaxRsApplicationSwagger2SpecificationRestlet addIntrospectorPlugin(IntrospectorPlugin introspectorPlugin) {
     ...
     *            The version of the Swagger specification.
     */
    public JaxRsApplicationSwagger2SpecificationRestlet setSwaggerVersion(String swaggerVersion) {
     ...
     *            The API version.
     */
    public JaxRsApplicationSwagger2SpecificationRestlet setApiVersion(String apiVersion) {
     ...
     *            The base path of the API
     */
    public JaxRsApplicationSwagger2SpecificationRestlet setBasePath(String basePath) {
