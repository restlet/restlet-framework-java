 ...
 * provide your own implementation of {@link ApplicationProvider}.
 * A server servlet will be created and registered with the web container at the
...
public interface ApplicationProvider {
    /**
     * The key constant that may be used to look up the {@link javax.servlet.ServletConfig} instance from the child context
     */
    String SERVLET_CONFIG_ATTRIBUTE = "javax.servlet.ServletConfig";

    /**
     * The key constant that may be used to look up the {@link javax.servlet.ServletContext} instance from the child context
     */
