...
import org.restlet.ext.platform.internal.agent.bean.CallLog;
...
public class AnalyticsHandler {
    ...
    /**
     * Maximum number of attempts to reach the Restlet Cloud analytics service if
     * there are errors before the call logs are lost.
     */
    private static final int MAX_ATTEMPTS = 5;

    /**
     * Maximum time between two attempts to reach the Restlet Cloud analytics
     * service.
     */
    private static final long MAX_TIME = TimeUnit.SECONDS.toMillis(10);

    /** Timer trigerring call logs post to Restlet Cloud */
    private Timer asyncPostTimer;

    /** Client resourceused to post call logs to Restlet Cloud */
     ...
     */
    public AnalyticsHandler(RestletCloudConfig restletCloudConfig,
            ModulesSettings modulesSettings) {
        analyticsClientResource = AgentUtils.getClientResource(restletCloudConfig,
