...
public class Swagger2TestCase extends RestletTestCase {
    ...
    private void compareMapOfStrings(Map<String, String> savedMap, Map<String, String> translatedMap) {
    ...
    private void compareStringLists(List<String> savedList, List<String> translatedList) {
    ...
    protected void compareSwaggerBeans(Swagger savedSwagger, Swagger translatedSwagger) {
    ...
    private void compareSwaggerContact(Contact savedContact, Contact translatedContact) {
    ...
    private void compareSwaggerMainAttributes(Swagger savedSwagger, Swagger translatedSwagger) {
    ...
    private void compareSwaggerOperations(com.wordnik.swagger.models.Operation savedOperation,
        ...
        if (savedOperation != null || translatedOperation != null) {
            ...
            if (savedParameters != null || translatedParameters != null) {
                ...
                for (com.wordnik.swagger.models.parameters.Parameter savedParameter : savedParameters) {
                    com.wordnik.swagger.models.parameters.Parameter translatedParameter =
                            getParameterFromList(translatedParameters, savedParameter.getName());
    ...
    private void compareSwaggerParameters(Parameter savedParameter, Parameter translatedParameter) {
        assertEquals(savedParameter.getDescription(), translatedParameter.getDescription());
        ...
        assertEquals(savedParameter.getRequired(), translatedParameter.getRequired());
    ...
    private void compareSwaggerPaths(Path savedPath, Path translatedPath) {
        ...
        compareSwaggerOperations(savedPath.getOptions(), translatedPath.getOptions());
        compareSwaggerOperations(savedPath.getPatch(), translatedPath.getPatch());
        ...
        compareSwaggerOperations(savedPath.getDelete(), translatedPath.getDelete());
    }

    private void compareSwaggerProperties(com.wordnik.swagger.models.properties.Property savedProperty,
        ...
        if (savedProperty != null || translatedProperty != null) {
            ...
            assertEquals(savedProperty.getFormat(), translatedProperty.getFormat());
            ...
            assertEquals(savedProperty.getRequired(), translatedProperty.getRequired());
            assertEquals(savedProperty.getTitle(), translatedProperty.getTitle());
            assertEquals(savedProperty.getType(), translatedProperty.getType());
            assertEquals(savedProperty.getPosition(), translatedProperty.getPosition());
        }
    }

    private void compareSwaggerResponses(com.wordnik.swagger.models.Response savedResponse,
        ...
        compareMapOfStrings(savedResponse.getExamples(), translatedResponse.getExamples());
        compareSwaggerProperties(savedResponse.getSchema(), translatedResponse.getSchema());
    }
    ...
    private com.wordnik.swagger.models.parameters.Parameter getParameterFromList(
            List<com.wordnik.swagger.models.parameters.Parameter> list, String parameterName) {
    ...
    protected void compareDefinitions(Definition savedDefinition, Definition translatedDefinition) {
        ...
        // Contact
        org.restlet.ext.platform.internal.model.Contact savedContact = savedDefinition.getContact();
        org.restlet.ext.platform.internal.model.Contact translatedContact = translatedDefinition.getContact();
        assertEquals(savedContact.getEmail(), translatedContact.getEmail());
        assertEquals(savedContact.getName(), translatedContact.getName());
        assertEquals(savedContact.getUrl(), translatedContact.getUrl());

        // License
        org.restlet.ext.platform.internal.model.License savedLicense = savedDefinition.getLicense();
        org.restlet.ext.platform.internal.model.License translatedLicense = translatedDefinition.getLicense();
        assertEquals(savedLicense.getName(), translatedLicense.getName());
        assertEquals(savedLicense.getUrl(), translatedLicense.getUrl());
    ...
    private void compareRwadefEndpoints(Definition savedDefinition, Definition translatedDefinition) {
        ...
        ImmutableMap<String, Endpoint> savedEndpoints = uniqueIndex(savedDefinition.getEndpoints(), Endpoint::computeUrl);
        ImmutableMap<String, Endpoint> translatedEndpoints = uniqueIndex(translatedDefinition.getEndpoints(), Endpoint::computeUrl);
    ...
    private void compareRwadefResources(Contract savedContract, Contract translatedContract) {
        ...
        ImmutableMap<String, Resource> savedResources = uniqueIndex(savedContract.getResources(), Resource::getResourcePath);
        ImmutableMap<String, Resource> translatedResources = uniqueIndex(translatedContract.getResources(), Resource::getResourcePath);
    ...
    private void compareRwadefPathVariables(Resource savedResource, Resource translatedResource) {
        ...
        ImmutableMap<String, PathVariable> savedPathVariables = uniqueIndex(savedResource.getPathVariables(),
                org.restlet.ext.platform.internal.model.Parameter::getName);
        ImmutableMap<String, PathVariable> translatedPathVariables = uniqueIndex(translatedResource.getPathVariables(),
                org.restlet.ext.platform.internal.model.Parameter::getName);
    ...
    private void compareRwadefOperations(Resource savedResource, Resource translatedResource) {
        ...
        ImmutableMap<String, Operation> savedOperations = uniqueIndex(savedResource.getOperations(), Operation::getName);
        ImmutableMap<String, Operation> translatedOperations = uniqueIndex(translatedResource.getOperations(), Operation::getName);
    ...
    private void compareRwadefResponses(Operation savedOperation, Operation translatedOperation) {
        ...
        ImmutableMap<Integer, Response> savedResponses = uniqueIndex(savedOperation.getResponses(), Response::getCode);
        ImmutableMap<Integer, Response> translatedResponses = uniqueIndex(translatedOperation.getResponses(), Response::getCode);
    ...
    private void compareRwadefQueryParameters(Operation savedOperation, Operation translatedOperation) {
        ...
        ImmutableMap<String, QueryParameter> savedQueryParameters = uniqueIndex(savedOperation.getQueryParameters(),
                org.restlet.ext.platform.internal.model.Parameter::getName);
        ImmutableMap<String, QueryParameter> translatedQueryParameters = uniqueIndex(translatedOperation.getQueryParameters(),
                org.restlet.ext.platform.internal.model.Parameter::getName);
    ...
    private void compareRwadefHeaders(List<Header> savedHeadersList, List<Header> translatedHeadersList) {
        ...
        ImmutableMap<String, Header> savedHeaders = uniqueIndex(savedHeadersList, org.restlet.ext.platform.internal.model.Parameter::getName);
        ImmutableMap<String, Header> translatedHeaders = uniqueIndex(translatedHeadersList, org.restlet.ext.platform.internal.model.Parameter::getName);
    ...
    private void compareRwadefRepresentations(Contract savedContract, Contract translatedContract) {
        ...
        ImmutableMap<String, Representation> savedRepresentations = uniqueIndex(savedContract.getRepresentations(), Representation::getName);
        ImmutableMap<String, Representation> translatedRepresentations = uniqueIndex(translatedContract.getRepresentations(), Representation::getName);
    ...
    private void compareRwadefProperties(List<Property> savedPropertiesList, List<Property> translatedPropertiesList) {
        if (assertBothNull(savedPropertiesList, translatedPropertiesList)) {
            return;
        }

        ImmutableMap<String, Property> savedProperties = uniqueIndex(savedPropertiesList, Property::getName);
        ImmutableMap<String, Property> translatedProperties = uniqueIndex(translatedPropertiesList, Property::getName);
    ...
    private void compareRwadefSections(Contract savedContract, Contract translatedContract) {
        ...
        ImmutableMap<String, Section> savedSections = uniqueIndex(savedContract.getSections(), Section::getName);
        ImmutableMap<String, Section> translatedSections = uniqueIndex(translatedContract.getSections(), Section::getName);
