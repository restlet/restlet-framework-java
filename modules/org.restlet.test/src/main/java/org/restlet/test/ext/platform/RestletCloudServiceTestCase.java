...
import org.restlet.ext.platform.internal.agent.bean.OperationAuthorization;
import org.restlet.ext.platform.internal.agent.bean.OperationsAuthorization;
...
import org.restlet.ext.platform.internal.agent.resource.AnalyticsResource;
import org.restlet.ext.platform.internal.agent.resource.AuthenticationAuthenticateResource;
 ...
 */
public class RestletCloudServiceTestCase extends RestletTestCase {
    ...
    public RestletCloudService getAgentService() {
        RestletCloudService RestletCloudService = new RestletCloudService();
        RestletCloudService.setAgentEnabled(true);
        RestletCloudService.setAgentServiceUrl(AGENT_SERVICE_URL);
        RestletCloudService.setAgentRefreshPeriodInSecond(0);
        RestletCloudService.setAgentLogin(VALID_USERNAME);
        RestletCloudService.setAgentPassword(VALID_PASSWORD);
        RestletCloudService.setAgentCellId(CELL_ID);
        RestletCloudService.setAgentCellVersion(CELL_VERSION);
        return RestletCloudService;
    }

    @Override
    protected void setUp() throws Exception {
        super.setUp();
        startAgentRestletCloudService();
    ...
    private void startRestletCloudService(final RestletCloudService RestletCloudService,
        ...
        application.getServices().add(RestletCloudService);
        this.agentComponent.getDefaultHost().attach(application);
        this.agentComponent.start();
    }

    public void startAgentRestletCloudService() throws Exception {
    ...
    public void testAgent_Authentication_userRequestWithCredentials()
        ...
        // run
        startRestletCloudService(getAgentService(), true);
    ...
    public void testAgent_Configuration_AuthorizationWithoutAuthentication()
        ...
        try {
            RestletCloudService RestletCloudService = getAgentService();
            startRestletCloudService(RestletCloudService, true);
    ...
    public void testAgent_Timer() throws Exception {
        // configure
        RestletCloudService RestletCloudService = getAgentService();
        RestletCloudService.setAgentRefreshPeriodInSecond(2);
        startRestletCloudService(RestletCloudService, true);
    ...
    public void testAgent_Analytics_Timer() throws Exception {
        ...
        RestletCloudService RestletCloudService = getAgentService();
        RestletCloudService.setAgentAnalyticsPostPeriodInSecond(2);
        RestletCloudService.createInboundFilter(null);
        startRestletCloudService(RestletCloudService, true);
    ...
    public void testAgent_Analytics_Broken() throws Exception {
        ...
        RestletCloudService RestletCloudService = getAgentService();
        RestletCloudService.setAgentAnalyticsBufferSize(1);
        startRestletCloudService(RestletCloudService, true);
    ...
    public void testAgent_Redirection_noUrl() throws Exception {
        // run
        RestletCloudService RestletCloudService = getAgentService();
        RestletCloudService.setReverseProxyEnabled(true);
        try {
            startRestletCloudService(RestletCloudService, true);
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
    ...
    public void testAgent_ReverseProxy() throws Exception {
        ...
        RestletCloudService RestletCloudService = getAgentService();
        RestletCloudService.setReverseProxyEnabled(true);
        RestletCloudService.setReverseProxyTargetUrl(USER_WEBAPI_URL);
        startRestletCloudService(RestletCloudService, false);
        startUserApi();
    ...
    public void testFirewall() throws Exception {
        ...
        // run
        RestletCloudService RestletCloudService = new RestletCloudService();
        RestletCloudService.setFirewallEnabled(true);
        RestletCloudService.getFirewallConfig().addRolesPeriodicCounter(1,
    ...
    public void testLoadConfiguration() throws Exception {
        ...
        assertEquals(Integer.valueOf(CELL_ID), RestletCloudService.getAgentCellId());
        assertEquals(Integer.valueOf(CELL_VERSION),
                RestletCloudService.getAgentCellVersion());
        assertTrue(RestletCloudService.isReverseProxyEnabled());
        assertEquals("http://myrealapi.com/",
                RestletCloudService.getReverseProxyTargetUrl());
    }
}
