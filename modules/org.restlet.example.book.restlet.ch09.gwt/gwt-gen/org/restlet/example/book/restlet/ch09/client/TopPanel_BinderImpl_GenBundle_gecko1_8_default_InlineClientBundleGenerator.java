...
public class TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator implements org.restlet.example.book.restlet.ch09.client.TopPanel_BinderImpl_GenBundle {
  private static TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator _instance0 = new TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new org.restlet.example.book.restlet.ch09.client.TopPanel_BinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GL0P3EKCFJ{text-align:" + ("left")  + ";margin:" + ("1em")  + ";}.GL0P3EKCDJ{text-align:" + ("left")  + ";}.GL0P3EKCEJ{height:" + ((TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getHeight() + "px")  + ";width:" + ((TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getSafeUri().asString() + "\") -" + (TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getLeft() + "px -" + (TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}")) : ((".GL0P3EKCFJ{text-align:" + ("right")  + ";margin:" + ("1em")  + ";}.GL0P3EKCDJ{text-align:" + ("right")  + ";}.GL0P3EKCEJ{height:" + ((TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getHeight() + "px")  + ";width:" + ((TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getSafeUri().asString() + "\") -" + (TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getLeft() + "px -" + (TopPanel_BinderImpl_GenBundle_gecko1_8_default_InlineClientBundleGenerator.this.logo()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}"));
      }
