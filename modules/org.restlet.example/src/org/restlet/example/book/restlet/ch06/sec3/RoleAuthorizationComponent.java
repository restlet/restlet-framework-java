...
import org.restlet.example.book.restlet.ch06.sec4.SecurityManagerDemoComponent;
 ...
 */
public class RoleAuthorizationComponent extends Component {
    public RoleAuthorizationComponent() {
        ...
        Application app = new RoleAuthorizationApplication(appContext);
