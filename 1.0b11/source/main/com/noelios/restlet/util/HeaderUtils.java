...
public class HeaderUtils
{
    ...
    * @throws IOException
    */
   public static Appendable appendUriEncoded(CharSequence source, Appendable destination) throws IOException
   {
      destination.append(URLEncoder.encode(source.toString(), "UTF-8"));
      return destination;
   }
