...
public class ContextResolver implements URIResolver {
    ...
    public Source resolve(String href, String base) {
        ...
        if (this.context != null) {
            ...
            Response response =
                    this.context.getClientDispatcher().handle(new Request(Method.GET, targetUri));
            ...
            if (response.getStatus().isSuccess() && response.isEntityAvailable()) {
                try {
                    ...
                    this.context
                            .getLogger()
                            .log(Level.WARNING, "I/O error while getting the response stream", e);
                }
            }
        }
