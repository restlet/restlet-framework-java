...
public class TransformerTestCase extends TestCase
{
	...
	public void testTransform() throws Exception
	{
		...
		Representation source = new StringRepresentation("<?xml version=\"1.0\"?>"
				+ "<purchase id=\"p001\">" + "<customer db=\"cust123\"/>"
				+ "<product db=\"prod345\">" + "<amount>23.45</amount>" + "</product>"
				+ "</purchase>");
		...
		assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\"?><buyer>cust123</buyer>23.45",
				result);
	}
